   ...
   public class HabboMain extends Sprite
   {
      ...
      private function prepareCore() : void
      {
         ...
         else
         {
            ...
            _loc1_.addEventListener(AssetLoaderEvent.const_51,configLoadedHandler);
         }
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_51,configLoadedHandler);
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_834,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_29);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_834,error);
            Core.dispose();
         }
      }
