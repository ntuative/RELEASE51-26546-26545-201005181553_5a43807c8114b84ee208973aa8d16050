package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      private var var_663:uint = 0;
      
      protected var var_384:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_30 = new Array();
         var_563 = new Array();
         var_973 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_384 = new AssetLibrary("lib-" + var_663++);
         var_30.push(var_384);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_384.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_384.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_563.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_384.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_384.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_384.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_384.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_663++);
         var_563.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_563.length)
            {
               _loc3_ = var_563[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_563.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_384.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_384.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_384.loadFromArchive(param1,param2);
      }
