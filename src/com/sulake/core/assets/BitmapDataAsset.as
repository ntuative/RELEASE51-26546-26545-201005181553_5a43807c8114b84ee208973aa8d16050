package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements IAsset
   {
      ...
      protected static var var_665:uint = 0;
      ...
      public function setUnknownContent(param1:Object) : void
      {
         ...
         if(param1 is BitmapDataAsset)
         {
            _bitmap = BitmapDataAsset(param1)._bitmap;
            _offset = BitmapDataAsset(param1)._offset;
            var_1049 = BitmapDataAsset(param1).var_1049;
            var_1048 = BitmapDataAsset(param1).var_1048;
            if(_bitmap != null)
            {
               return;
            }
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  var_1049 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  var_1048 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
