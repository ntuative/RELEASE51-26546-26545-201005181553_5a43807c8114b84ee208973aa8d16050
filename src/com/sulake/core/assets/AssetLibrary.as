package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1097:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_635:uint = 0;
      
      public static const const_1002:String = "AssetLibraryReady";
      
      public static const const_1249:String = "AssetLibraryUnloaded";
      
      public static const const_456:String = "AssetLibraryLoaded";
      
      public static const const_1192:String = "AssetLibraryLoadError";
       
      
      private var var_544:XML;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_444)
         {
            _loc4_ = AssetTypeDeclaration(var_444[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_760)
         {
            delete var_760[_loc1_];
         }
         if(var_15 != null)
         {
            var_15.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_544 = _loc2_.manifest.copy();
         var_374 = _loc2_.resource;
         if(var_543)
         {
            AssetLibrary.fetchLibraryContents(this,var_544,var_374);
         }
         var_317 = true;
         dispatchEvent(new Event(AssetLibrary.const_456));
         dispatchEvent(new Event(AssetLibrary.const_1002));
         if(var_543)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_51,assetLoadEventHandler);
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_828,assetLoadEventHandler);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_444.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_444[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1097.splice(var_1097.indexOf(this),1);
            --var_635;
            var_443 = null;
            var_760 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1192));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_444[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_15 == null)
            {
               var_15 = new LibraryLoader(var_1412);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_544.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_374[param1]);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_36:
               ...
               if(decl != null)
               {
                  ...
                  {
                     asset.dispose();
                     e = new AssetLoaderEvent(AssetLoaderEvent.const_51,e.status);
                     break;
                  }
                  if(true)
                  {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_444[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_374 != null ? false : false;
      }
   }
}
