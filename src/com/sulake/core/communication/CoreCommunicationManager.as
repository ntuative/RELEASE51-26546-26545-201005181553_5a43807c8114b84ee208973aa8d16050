package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = var_720[_loc3_];
      ...
      {
         var _loc3_:Array = var_720[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_720[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1250)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = var_719[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
