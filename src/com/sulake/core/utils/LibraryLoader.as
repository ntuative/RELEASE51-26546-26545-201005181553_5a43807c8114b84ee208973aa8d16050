package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1060:int = 5;
      ...
      protected var var_169:int = 0;
      
      protected var var_544:XML;
      
      protected var var_1139:Boolean = true;
      
      protected var var_1418:Boolean = false;
      
      protected var var_463:uint = 0;
      
      protected var var_15:Loader;
      
      protected var var_2319:String = "";
      ...
      protected var var_374:Class;
      
      protected var var_2427:uint = 0;
      ...
      {
         var_2319 = param1;
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,var_169,bytesTotal,bytesLoaded));
      }
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_374 = this.getDefinition(_name) as Class;
         if(var_374 == null)
         {
         ...
         try
         {
            xmlClass = var_374.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_544 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(var_1412)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,var_169,bytesTotal,bytesLoaded));
         }
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case Event.INIT:
               ...
               var_463 |= LibraryLoader.STATE_EVENT_INIT;
               break;
            case Event.COMPLETE:
               debug("Load event COMPLETE for file \"" + var_15.contentLoaderInfo.url + "\"");
               var_463 |= LibraryLoader.STATE_EVENT_COMPLETE;
               break;
            case Event.ENTER_FRAME:
               break;
            case HTTPStatusEvent.HTTP_STATUS:
               var_169 = HTTPStatusEvent(param1).status;
               debug("Load event STATUS " + var_169 + " for file \"" + var_15.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
               debug("Load event UNLOAD for file \"" + var_15.contentLoaderInfo.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,var_169,bytesTotal,bytesLoaded));
               break;
            case ProgressEvent.PROGRESS:
               debug("Load event PROGRESS for file \"" + var_15.contentLoaderInfo.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,var_169,bytesTotal,bytesLoaded));
               break;
         ...
         if(var_463 == LibraryLoader.STATE_ANALYZE)
         {
            if(analyzeLibrary())
            {
               var_463 |= LibraryLoader.STATE_EVENT_FRAME;
            }
         }
         if(var_463 == LibraryLoader.STATE_READY)
         {
            var_1418 = true;
            prepareLibrary();
            removeEventListeners();
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,var_169,bytesTotal,bytesLoaded));
         }
      }
