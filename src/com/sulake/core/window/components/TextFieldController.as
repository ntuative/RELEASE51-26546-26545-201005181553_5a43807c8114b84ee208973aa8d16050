package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_799:Boolean = false;
      
      protected var var_968:uint = 500;
      
      protected var var_971:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_867,var_8);
         }
         return var_17;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_971,PropertyStruct.const_63,var_971 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_799 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               var_971 = _loc2_.value as Boolean;
               if(var_971)
               {
