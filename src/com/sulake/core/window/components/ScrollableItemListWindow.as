package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_844:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_357)
         {
            ...
            if(var_357)
            {
               var_357.addEventListener(WindowEvent.const_263,scrollBarEventProc);
               var_357.addEventListener(WindowEvent.const_208,scrollBarEventProc);
            }
         }
         return var_357;
      }
      ...
      override public function dispose() : void
      {
         if(var_357)
         {
            var_357.removeEventListener(WindowEvent.const_263,scrollBarEventProc);
            var_357.removeEventListener(WindowEvent.const_208,scrollBarEventProc);
            var_357 = null;
         }
         if(var_844)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_844)
         {
            var_844 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_844;
      }
