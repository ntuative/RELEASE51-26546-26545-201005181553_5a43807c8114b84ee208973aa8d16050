package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1128:String = "increment";
      
      private static const const_515:String = "slider_bar";
      
      private static const const_1129:String = "decrement";
      
      private static const const_791:String = "slider_track";
      ...
      protected var var_787:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_165 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_380;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_479)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_791) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_21 != null && true)
         {
            IWindow(var_21).removeEventListener(WindowEvent.const_48,method_4);
         }
         var_21 = param1;
         if(var_21 != null && true)
         {
            IWindow(var_21).addEventListener(WindowEvent.const_48,method_4);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_515) as WindowController;
      }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1128)
            {
               if(var_21)
               {
                  var_614 = true;
            ...
            else if(param2.name == ScrollbarController.const_1129)
            {
               if(var_21)
               {
                  var_614 = true;
            ...
            else if(param2.name == ScrollbarController.const_791)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_1020)
         {
