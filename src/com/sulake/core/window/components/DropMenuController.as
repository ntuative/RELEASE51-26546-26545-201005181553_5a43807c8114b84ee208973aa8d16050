package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_358:String = "_DROPMENU_TITLETEXT";
       
      
      private var var_127:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_127 == null || false)
         {
            var_127 = context.create(name + "::submenu","",WindowType.const_455,var_82,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_127.setGlobalRectangle(_loc1_);
         }
         var_127.activate();
         return var_127;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_865)
         {
            if(param2 == var_127)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_381,var_82,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_313,var_82,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_478 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_478).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_583)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_477,getSubMenu(),subMenuEventProc);
                  var_583 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_480,this,null,true);
         update(this,_loc2_);
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_127 != null)
            {
               _loc2_ = var_127.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      {
         return getChildByName(DropMenuController.const_358) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_583 = false;
            getTitleText().text = var_478 < var_477.length && var_478 > -1 ? "null" : caption;
         }
      }
   }
}
