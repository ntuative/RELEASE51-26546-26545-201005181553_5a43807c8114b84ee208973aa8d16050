package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow
   {
      ...
      protected static const const_358:String = "_BTN_TEXT";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         switch(event.type)
         {
            ...
            case WindowNotifyEvent.const_586:
               try
               {
                  getChildByName(const_358).blend = getChildByName(const_358).blend + 0.5;
               }
               catch(e:Error)
               {
               }
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(getChildByName(const_358));
         if(_loc2_ != null)
         {
            _loc2_.text = caption;
         }
