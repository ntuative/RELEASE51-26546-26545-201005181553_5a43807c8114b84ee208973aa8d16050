package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2382:Rectangle = new Rectangle();
      ...
      {
         return new Rectangle(var_657 * maxScrollH,var_381 * maxScrollV,width,height);
      }
      ...
      {
         var_657 = param1;
         _field.scrollH = var_657 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_393,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_393,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_742,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_742,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_742,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
