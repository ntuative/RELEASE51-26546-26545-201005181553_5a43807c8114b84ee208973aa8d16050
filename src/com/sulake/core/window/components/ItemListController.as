package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1057:String = "resize_on_item_update";
      ...
      protected static const const_1056:String = "scale_to_fit_items";
      ...
      protected var var_2380:Number = 0;
      
      protected var var_559:Boolean = false;
      
      protected var var_2379:Number = 0;
      
      protected var var_560:Number;
      
      protected var var_1136:Boolean = false;
      ...
      protected var var_789:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_165 = var_658 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_313,WindowStyle.const_338,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_560 * maxScrollH,var_558 * maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_560 = param1;
            _container.x = -var_560 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1054,_spacing,PropertyStruct.const_69,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1055,var_789,PropertyStruct.const_63,var_789 != const_1437));
         _loc1_.push(new PropertyStruct(const_1056,var_559,PropertyStruct.const_63,var_559 != const_1438));
         _loc1_.push(new PropertyStruct(const_1057,var_1136,PropertyStruct.const_63,var_1136 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1057:
                  ...
                  break;
               case const_1055:
                  var_789 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_428,param1);
            }
            else
            {
