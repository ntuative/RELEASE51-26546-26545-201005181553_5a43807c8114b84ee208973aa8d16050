package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_801:String = "margin_top";
      
      private static const const_1134:String = "_HEADER";
      
      private static const const_799:String = "margin_right";
      
      private static const const_1135:String = "_SCALER";
      
      private static const const_1118:String = "_TITLE";
      
      private static const const_1136:String = "_CONTENT";
      
      private static const const_802:String = "margin_left";
      
      private static const const_800:String = "margin_bottom";
      ...
      private var var_1286:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_802,_loc3_.left,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_801,_loc3_.top,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_799,0 - _loc3_.right,PropertyStruct.const_69,_loc2_));
         _loc1_.push(new PropertyStruct(const_800,0 - _loc3_.bottom,PropertyStruct.const_69,_loc2_));
         return _loc1_;
      }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1286 == null)
         {
            var_1286 = findChildByTag(const_1134) as IHeaderWindow;
            if(!var_1286)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1118) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1135) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1418 ? content.iterator : new Iterator(this);
      }
