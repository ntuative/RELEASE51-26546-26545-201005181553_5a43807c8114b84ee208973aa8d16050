package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_867:uint = 2;
      
      public static const const_1552:uint = 128;
      
      public static const const_1497:uint = 64;
      
      public static const const_677:uint = 4;
      
      public static const const_1353:uint = 0;
      
      public static const const_1244:uint = 16;
      
      public static const const_624:uint = 1;
      
      public static const const_1230:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_656:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_867:
               ...
               break;
            case GraphicContext.const_1230:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1244:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_677:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_853:
               break;
            case GraphicContext.const_1353:
               break;
            default:
         ...
         if(var_656)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1633,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1633,16777215);
                  }
                  var_387 += bitmap.width * bitmap.height * 4;
               }
