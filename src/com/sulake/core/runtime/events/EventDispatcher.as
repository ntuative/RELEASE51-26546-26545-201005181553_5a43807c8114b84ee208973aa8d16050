package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1075:uint = 1;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_768)
            {
               if(var_676 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_676.errorID,var_676);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_676);
               }
            }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1075) : uint(const_507);
      }
