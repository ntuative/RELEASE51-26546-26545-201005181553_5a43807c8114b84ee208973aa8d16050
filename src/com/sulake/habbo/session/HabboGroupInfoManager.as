package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = var_251.getValue(_loc2_.groupId);
         var_1084[_loc2_.groupId] = _loc3_;
      ...
      private function onHabboGroupBadges(param1:IMessageEvent) : void
      {
         ...
         while(_loc6_ < _loc3_.length)
         {
            ...
            if(var_251.getValue(_loc4_) != null)
            {
               var_251.remove(_loc4_);
            }
            var_251.add(_loc4_,_loc3_.getWithIndex(_loc6_));
            _loc6_++;
         }
      }
      ...
      {
         return var_251.getValue(param1);
      }
      ...
      {
         var _loc2_:HabboGroupDetails = var_1084[param1];
         if(_loc2_ == null)
         {
