package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1114:UserDataManager;
      ...
      {
         if(var_35 == RoomSessionEvent.const_342 && _connection != null)
         {
            var_35 = RoomSessionEvent.const_98;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1114 as IUserDataManager;
      }
