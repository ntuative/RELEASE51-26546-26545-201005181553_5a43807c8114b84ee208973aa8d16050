package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_807:uint = 11;
       
      
      private var var_241:LatencyTracker = null;
      
      private var var_240:PerformanceTracker = null;
      ...
      private var var_917:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_240 = new PerformanceTracker();
         var_241 = new LatencyTracker();
         var_918 = new LagWarningLogger();
         var_1323 = new Array(const_807);
         var _loc4_:int = 0;
         while(_loc4_ < const_807)
         {
            var_1323[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1352,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1431,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_630,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1031,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1360);
               break;
            case HabboCommunicationEvent.const_755:
               trackLoginStep(HabboLoginTrackingStep.const_1235,String(_communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_241 != null)
            {
               var_241.communication = _communication;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_160)
         {
            Component(var_160).events.addEventListener(HabboConfigurationEvent.const_193,onConfigurationLoaded);
            if(var_241 != null)
            {
               var_241.configuration = var_160;
            }
            if(var_240 != null)
            {
               var_240.configuration = var_160;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_274.events.addEventListener(AdEvent.const_483,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_2128)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1386);
            var_2128 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1031,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_636,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_487:
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_917)
            {
               var_917.release(new IIDHabboWindowManager());
               var_917 = null;
            }
            if(var_274)
            {
            ...
            if(var_182)
            {
               if(true)
               {
                  Component(var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_182).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_182).events.removeEventListener(HabboFriendListTrackingEvent.const_323,onFriendlistTrackingEvent);
               }
               var_182.release(new IIDHabboFriendList());
               var_182 = null;
            }
            if(var_162)
            {
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_487,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_160)
         {
            if(var_918 != null)
            {
               var_918.configure(var_160);
            }
            Component(var_160).events.removeEventListener(HabboConfigurationEvent.const_193,onConfigurationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_1043);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_1043,onCoreRunning);
         }
      }
      ...
      {
         var_917 = IHabboWindowManager(param2);
         if(var_917)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1087 > -1 && _loc2_ < var_1087)
         {
            ++var_1560;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1560);
         }
         if(var_1087 > -1 && _loc2_ - var_1087 > 15000)
         {
            ++var_1561;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1561);
         }
         var_1087 = _loc2_;
         if(var_240 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_487,onLagWarningEvent);
      ...
      {
         var_182 = param2 as IHabboFriendList;
         Component(var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_182).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_182).events.addEventListener(HabboFriendListTrackingEvent.const_323,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         {
            _crashed = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_10,new Date().getTime().toString());
            if(var_160)
            {
               if(var_160.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_240 != null)
                  {
                     _loc4_["null"] = var_240.flashVersion;
                     _loc4_["null"] = var_240.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_636)
         {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1181);
         }
      }
   }
}
