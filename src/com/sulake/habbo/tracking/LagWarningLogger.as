package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1384 || var_1477 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1478 == 0 || _loc1_ - var_1478 > var_1477)
         {
            if(_connection != null)
            {
      ...
      {
         var_1384 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1477 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
