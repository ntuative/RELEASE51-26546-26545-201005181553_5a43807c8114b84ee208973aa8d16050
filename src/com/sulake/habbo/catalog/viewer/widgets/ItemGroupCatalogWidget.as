package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_653[var_1123] as Array;
      ...
      {
         var _loc2_:Offer = var_653[var_1123][var_2293];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_491 || _loc1_.pricingModel == Offer.const_453)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_83 || _loc3_.productType == ProductTypeEnum.const_82)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1124.indexOf(_loc5_) == -1)
                        {
                           var_1124.push(_loc5_);
                           var_653.push(new Array());
                        }
                        _loc6_ = var_1124.indexOf(_loc5_);
                        (var_653[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_653)
         {
            if(var_2293 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2293] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1123 = var_972.getGridItemIndex(param1.view);
