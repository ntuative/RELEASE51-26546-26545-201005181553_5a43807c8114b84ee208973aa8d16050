package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IAvatarImageListener
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_413 >= var_306.length)
         {
            return "";
         }
         var petColor:IPetColor = var_306[var_413] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_597[var_1491] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_413 < 0 || var_413 > var_306.length)
         {
            var_413 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         var_853 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_306 = [];
         var_597 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_853,this);
               if(_loc11_)
               {
         ...
         while(_loc6_ < var_597.length)
         {
            ...
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_853,_loc12_.id),getRaceLocalizationKey(var_853,_loc12_.id)));
            _loc6_++;
         }
         var_569.add(var_853,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_1032,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_413 >= 0 && var_413 < var_306.length)
         {
            _loc7_ = var_306[var_413] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_597[var_1491] as IBreed;
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_853,_loc3_.id,_loc2_,AvatarScaleType.const_56,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_295,AvatarAction.const_631);
