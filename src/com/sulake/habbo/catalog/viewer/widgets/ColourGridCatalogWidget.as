package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1206 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_301 = null;
         for each(_loc1_ in var_1205)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1206) as IWindowContainer;
            _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc2_.background = true;
            _loc2_.color = 4294967295;
            _loc2_.width = var_694.width;
            _loc2_.height = var_694.height;
            _colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_694.width,var_694.height,true,0);
               _loc3_.bitmap.copyPixels(var_694,var_694.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_888.width,var_888.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_736.width,var_736.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_736,var_736.rect,new Point(0,0),null,null,true);
