package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1288:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_622 != null)
         {
            var_622.visible = false;
            var_622.destroyGridItems();
         }
         if(var_1288 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1159.text = "${" + _loc3_.name + "}";
            var_1160.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1159.text = "${" + _loc2_.localizationId + "}";
            var_1160.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_464:
                  _loc4_ = var_1289.clone();
                  if(var_622 != null)
                  {
                     var_622.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_622,var_1288,var_1183);
                  }
                  break;
               case Offer.const_491:
                     ...
                     case ProductTypeEnum.const_216:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_295,AvatarAction.const_626);
                              _loc13_.appendAction(AvatarAction.const_711,_loc6_.productClassId);
      ...
      {
         var_1159 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1160 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1538 = new Point(var_87.x,var_87.y);
         var_622 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1288 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_622 == null)
         {
         ...
         var_1289 = _loc2_.content as BitmapData;
