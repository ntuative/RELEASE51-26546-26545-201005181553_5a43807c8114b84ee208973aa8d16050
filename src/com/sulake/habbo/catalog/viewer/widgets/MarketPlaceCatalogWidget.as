package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_929:MarketPlaceOfferData;
      
      private const const_1456:int = 1;
      
      private const const_1736:int = 40;
      ...
      private const const_1737:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_546)
         {
            ...
            var_546 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_546)
         {
            return;
         ...
         updateStatusDisplay(const_1457,_loc2_.length);
         if(!var_451)
         {
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_546 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_546.clone() as IWindowContainer;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_928 >= var_569.length)
            {
               return true;
            }
            addListItem(var_569.getWithIndex(var_928));
            ++var_928;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_929.offerId);
            }
            return;
         }
