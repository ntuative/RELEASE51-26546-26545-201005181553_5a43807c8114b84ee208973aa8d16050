package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_685[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_685 = recycler.getPrizeTable();
         if(var_685 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_685[0].prizes.length > 0)
         {
            select(var_685[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1184) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1183) as IWindowContainer;
