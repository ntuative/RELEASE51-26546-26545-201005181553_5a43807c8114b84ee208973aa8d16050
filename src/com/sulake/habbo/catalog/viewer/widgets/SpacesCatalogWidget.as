package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1174:String = "default";
      ...
      private var var_1175:String = "1.1";
         ...
         switch(param1)
         {
            case const_201:
               ...
               for each(_loc8_ in var_160.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_746 = _loc8_.children().length();
                  }
               }
            ...
            case const_200:
               ...
               for each(_loc9_ in var_160.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_747 = _loc9_.children().length();
                  }
               }
            ...
            case const_202:
               ...
               for each(_loc10_ in var_160.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_745 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1174);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1303[var_311];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1175);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1174,var_1175,64,this,"window_romantic_wide");
