package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_454.getWithIndex(var_209);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_549);
            if(_loc3_ == null)
            {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_454.getValue(_loc6_) == null)
            {
               var_454.add(_loc6_,new Map());
            }
            _loc8_ = var_454.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_454.getWithIndex(var_209);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_549);
            if(_loc3_ == null)
            {
