package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1456:int = 1;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         updateStatusDisplay(const_1457,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc10_ = _loc6_[_loc7_];
            _loc11_ = param1.getValue(_loc10_) as MarketPlaceOfferData;
            if(_loc11_.status == MarketPlaceOfferState.const_448)
            {
               _loc5_++;
            }
            ...
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_877)
                  {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_1001)
                  {
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_877,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_448,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               _itemTemplates.add(MarketPlaceOfferState.const_1001,_loc2_);
            }
         }
         marketPlace.registerVisualization(this);
         displayMainView();
         marketPlace.requestOwnItems();
         updateStatusDisplay(const_1456);
      ...
      public function listUpdatedNotify() : void
      {
         ...
         updateList(marketPlace.method_8());
      }
