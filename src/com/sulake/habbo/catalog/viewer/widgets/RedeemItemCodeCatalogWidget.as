package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_985 != null)
         {
            var_985.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_984 != null)
         {
            var_984.removeEventListener(WindowKeyboardEvent.const_145,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_985 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_985 != null)
         {
            var_985.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_984 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_984 != null)
         {
            var_984.addEventListener(WindowKeyboardEvent.const_145,windowKeyEventProcessor);
         }
      }
