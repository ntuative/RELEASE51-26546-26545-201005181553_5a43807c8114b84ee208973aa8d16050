package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1380:IProductData;
      ...
      {
         super();
         var_1379 = param1.productType;
         var_1378 = param1.furniClassId;
         var_1115 = param1.extraParam;
         var_1116 = param1.productCount;
         var_1377 = param1.expiration;
         var_1380 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_83:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1115);
               break;
