package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1420 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1420) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_955);
      }
      ...
      {
         return _localization.getLinks(var_955);
      }
