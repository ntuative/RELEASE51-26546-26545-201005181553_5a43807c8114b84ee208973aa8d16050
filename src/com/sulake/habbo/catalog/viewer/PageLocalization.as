package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1132:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_615.length)
         {
            _loc2_ = String(var_615[param1]).replace("#","0x");
