package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1444:uint = 4.294967295E9;
      
      private const const_1443:uint = 4.293848814E9;
      
      private var var_832:int;
      
      private const const_1715:uint = 4.291613146E9;
      
      private var var_255:int = -1;
      ...
      {
         return param1 % 2 == 0 ? uint(const_1443) : uint(const_1444);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_405,var_80,var_1017);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_255) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc9_:int = !!_loc6_ ? 0 : int(var_592[var_198]);
         _catalog.purchaseProductAsGift(var_405,var_80,var_1017,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_141:
               ...
               if(var_1825 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_219)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1716)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1825 = _loc3_.text;
               break;
            case WindowMouseEvent.const_54:
               showSuggestions(false);
               if(var_1204)
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_216:
                  ...
                  break;
               case ProductTypeEnum.const_304:
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_255) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_255);
         }
         var_255 = param1;
         if(var_255 < 0)
         {
            var_255 = _loc2_.numListItems - 1;
         }
         if(var_255 >= _loc2_.numListItems)
         {
            var_255 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_255) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_499 == null)
         {
            var_499 = createWindow("suggestion_list_item") as IWindowContainer;
            var_499.procedure = suggestionsEventHandler;
         }
         if(var_222 == null || var_499 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_222.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_499.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
