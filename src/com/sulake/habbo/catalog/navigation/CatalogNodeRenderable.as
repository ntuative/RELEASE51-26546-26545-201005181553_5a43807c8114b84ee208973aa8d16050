package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1156:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1593:XML;
      ...
      private var var_1592:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1592 == 4294967295)
            {
               var_1592 = _loc1_.color;
            }
            _loc1_.color = const_1156;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1413;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1593) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_49 = navigator.catalog.windowManager.buildFromXML(var_1591) as IItemListWindow;
         if(var_49 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1434;
            }
         }
      }
