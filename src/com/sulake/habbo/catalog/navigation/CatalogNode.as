package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNode implements ICatalogNode
   {
      ...
      private static const const_1061:Array = [4293190884,4293914607,4294957908,4289454682,4289431551,4285716709,4294016606,4293326172,4293694138,4285383659,4293082689,4288782753];
      ...
      public function CatalogNode(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         var_1104 = param3;
         _navigator = param1;
         var_1639 = param2.navigateable;
         _localization = param2.localization;
         _pageId = param2.pageId;
         _color = const_1061[param2.color];
         var_755 = param2.icon;
         var_1266 = param2.disabled;
         _children = [];
      }
      ...
      protected function get iconName() : String
      {
         ...
         return ICON_PREFIX + var_755.toString();
      }
