package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1611)
         {
            case RecyclerStatusMessageEvent.const_1311:
               var_284 = const_369;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_899:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1611 != RecyclerStatusMessageEvent.const_899;
      }
      
      private function get statusActive() : Boolean
      {
         return var_284 != const_814;
      }
      ...
      {
         return active && var_284 == const_369;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_843:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1309:
