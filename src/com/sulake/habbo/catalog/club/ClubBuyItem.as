package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         _window = var_405.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         if(!var_405 || true || !var_405.viewer.catalog || !var_405.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = var_405.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:ClubBuyController = (var_405.viewer.catalog as HabboCatalog).getClubBuyController();
         (var_405.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_80,var_405);
      }
   }
}
