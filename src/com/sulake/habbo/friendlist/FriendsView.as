package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1723:IContainerButtonWindow;
      
      private var var_1725:IContainerButtonWindow;
      
      private var var_1724:IContainerButtonWindow;
      
      private var var_1726:IContainerButtonWindow;
      ...
      {
         var_1725 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1724 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1723 = initButton("room_invite",onInviteButtonClick,param1);
         var_1726 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_256)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_256 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1725,isEnableMinimailButton(_loc1_));
         setEnabled(var_1724,isEnableHomeButton(_loc1_));
         setEnabled(var_1723,isEnableInviteButton(_loc1_));
         setEnabled(var_1726,isEnableRemoveButton(_loc1_));
      }
