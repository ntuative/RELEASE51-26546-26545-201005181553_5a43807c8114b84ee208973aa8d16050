package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_706 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_706.procedure = onSearchInput;
         var_706.addEventListener(WindowKeyboardEvent.const_145,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_49.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_334,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_706.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
