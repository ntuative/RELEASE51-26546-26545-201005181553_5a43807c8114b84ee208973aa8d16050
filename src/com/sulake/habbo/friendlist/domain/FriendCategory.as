package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_311:int = 100;
      ...
      {
         return Math.ceil(this.var_219.length / const_311);
      }
      ...
      {
         if(this.var_827 >= this.getPageCount())
         {
            this.var_827 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_219[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_219.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_827 + 1) * const_311,this.var_219.length);
      }
