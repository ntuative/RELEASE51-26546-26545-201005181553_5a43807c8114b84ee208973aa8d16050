package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1543:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_623 = param1.gender;
         var_741 = param1.online;
         var_1176 = param1.followingAllowed && param1.online;
         var_299 = param1.figure;
         var_1312 = param1.motto;
         var_1314 = param1.lastAccess;
         var_1229 = param1.categoryId;
         var_1313 = param1.realName;
