package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_324 && _loc4_.state != FriendRequest.const_348)
            {
      ...
      {
         var_1459 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1460 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1460.procedure = onDismissAllButtonClick;
         var_1459.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1047)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1459,_loc1_);
         setEnabled(var_1460,_loc1_);
      }
