package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1564:OpenedToWebPopup;
      ...
      private var var_1563:AvatarSearchResults;
      ...
      private var var_2130:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_919:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2130 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1563 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_429.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_91.addCategory(new FriendCategory(FriendCategory.const_938,getText("friendlist.friends")));
         var_91.addCategory(new FriendCategory(FriendCategory.const_466,getText("friendlist.friends.offlinecaption")));
         ...
         getBuddyRequests();
         registerListeners();
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_145)
         {
            var_145.release(new IIDHabboMessenger());
            var_145 = null;
         }
         if(var_160)
         {
         ...
         if(var_920)
         {
            var_920.release(new IIDAvatarRenderManager());
            var_920 = null;
         }
         if(var_919)
         {
            var_919.release(new IIDHabboNotifications());
            var_919 = null;
         }
         if(var_204)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_145 = param2 as IHabboMessenger;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1563.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = var_429.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_920.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_429.findTab(FriendListTab.const_88);
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1564 == null)
         {
            var_1564 = new OpenedToWebPopup(this);
         }
         var_1564.show(x,y);
      }
