package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1432:uint = 13232628;
      ...
      private var var_805:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_29.localization.registerParameter("help.tutorial.name.available","name",var_343);
      ...
      private function showSelectionView() : void
      {
         if(!var_576)
         {
            var_576 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_576)
            {
               return;
            }
            _window.content.addChild(var_576);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_271)
         {
            var_271 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_271)
            {
               return;
            }
            _window.content.addChild(var_271);
         }
         _window.caption = var_29.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_271.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_343;
         }
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1153 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_962:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_959:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1126 || param1 == ChangeUserNameResultMessageEvent.var_1127)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_805 = new NameSuggestionListRenderer(var_29);
         var _loc6_:int = var_805.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1432;
