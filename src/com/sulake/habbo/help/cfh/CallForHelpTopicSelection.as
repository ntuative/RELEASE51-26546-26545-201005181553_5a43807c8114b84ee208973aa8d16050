package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_774 == null || _loc3_ < 0 || _loc3_ >= var_774.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_774[_loc3_];
            main.showUI(HabboHelpViewEnum.const_647);
            main.tellUI(HabboHelpViewEnum.const_647,null);
         }
      }
   }
}
