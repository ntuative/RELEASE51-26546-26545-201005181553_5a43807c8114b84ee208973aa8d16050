package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         var_642 = main.component.userRegistry.getRegistry();
         if(false)
         {
            main.showUI(HabboHelpViewEnum.const_157);
         ...
         var i:int = 0;
         while(i < var_642.length)
         {
            u = var_642.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > var_642.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = var_642.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
