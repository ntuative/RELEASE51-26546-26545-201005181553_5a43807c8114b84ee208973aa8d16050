package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_627 = _main.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_627.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         _main.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.HELP_ARROW,var_627));
      }
