package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_218:String = "TUI_NAME_VIEW";
      
      public static const const_92:String = "TUI_MAIN_VIEW";
      
      public static const const_299:String = "TUI_CLOTHES_VIEW";
      
      public static const const_497:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function prepareForTutorial() : void
      {
         ...
         _main.hideUI();
         _main.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_111));
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_977 = param2;
         var_975 = param3;
         if(var_33 == null || var_33.id == const_92)
         {
            prepareForTutorial();
            showView(const_92);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_33 != null && (var_33.id == const_218 || var_33.id == const_92))
         {
            showView(const_92);
         }
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1526;
         _window.width = _loc2_.width + var_1525;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode != ChangeUserNameResultMessageEvent.var_654)
         {
            showView(const_218);
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_462:
               var_975 = true;
               if(var_33 != null && var_33.id == const_497)
               {
                  showView(const_92);
               }
               break;
            case HabboHelpTutorialEvent.const_490:
               if(var_33 != null && var_33.id == const_299)
               {
                  var_1143 = true;
                  disposeWindow();
               }
      ...
      {
         var_976 = true;
         if(var_33 != null && (var_33.id == const_299 || var_33.id == const_92))
         {
            showView(const_92);
         }
      }
      ...
      {
         return var_976 && var_977 && var_975;
      }
   }
}
