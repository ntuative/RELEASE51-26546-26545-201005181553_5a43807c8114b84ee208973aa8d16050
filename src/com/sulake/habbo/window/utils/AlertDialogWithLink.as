package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialogWithLink extends AlertDialog implements IAlertDialogWithLink
   {
      ...
      protected var var_1636:String = "";
      
      protected var var_1637:String = "";
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_link":
                  HabboWebTools.navigateToURL(var_1636,"_empty");
                  return;
            }
         }
      ...
      public function set linkTitle(param1:String) : void
      {
         ...
         if(_window)
         {
            IButtonWindow(_window.findChildByTag("LINK")).caption = var_1637;
         }
      }
