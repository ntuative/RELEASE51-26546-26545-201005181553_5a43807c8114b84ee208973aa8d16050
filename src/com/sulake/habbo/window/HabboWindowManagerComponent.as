package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1199:IEventDispatcher;
      
      private var var_2410:uint = 0;
      
      private var var_1200:ProfilerAgentTask;
      
      private var var_1201:ProfilerOutput;
      
      private var var_693:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1199 = Component(param1).events;
         var_407 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_692 = new SkinContainer(_loc3_.content as XML,assets);
         var_693 = new WindowRenderer(var_692);
         var_221 = new Array(const_360);
         var _loc5_:int = 0;
         while(_loc5_ < const_360)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_693,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_221[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_221[const_1094];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_350,_loc6_);
      ...
      {
         var _loc3_:Dictionary = var_407[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_407[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1201 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1201 = new ProfilerOutput(_loc3_,this,var_693);
      ...
      {
         return var_692.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_963.length > 0)
         {
            var_1199.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_360 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1199.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_963.length > 0)
         {
            WindowContext.var_963.flush();
         }
         if(WindowContext.var_1403.length > 0)
         {
            WindowContext.var_1403.flush();
         }
         var_1199.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1279,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1305,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1276,param2.name + ": " + param2.toString());
            }
         }
      }
   }
