package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_120,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_821,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_171,onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_416,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_637,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1033,onHideWindowEvent);
         var_35 = true;
