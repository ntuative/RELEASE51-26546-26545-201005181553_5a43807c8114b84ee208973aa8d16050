package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1566:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_273:ToolbarBarMenuAnimator;
      
      private var var_1567:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_206 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_1051,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1088 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1088)
         {
         ...
         var_1566 = _loc7_.toolbar.@min_group_margin;
         var_1567 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_276,param1,param2,_window,var_273);
         createGroupsFromXmlList(_loc9_,var_633,param1,param2,var_206,var_273);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_140,var_541,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1566,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1326) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1566,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1326) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_140,var_541);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_140,var_541);
         }
      }
