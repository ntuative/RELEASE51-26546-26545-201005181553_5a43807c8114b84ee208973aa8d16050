package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1284 = param1.loop;
         if(param1.background != null)
         {
            var_891 = getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(var_1284 == true || var_740 == 0)
         {
            if(false)
            {
               ++var_53;
               if(var_53 >= var_893.length)
               {
                  var_53 = 0;
                  ++var_740;
               }
      ...
      {
         return var_1284 == false && var_740 == 1 && var_1261 != var_35;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_891 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_891.width),Math.max(param2.height,var_891.height));
            _loc3_.copyPixels(var_891,var_891.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_53 <= var_892.length)
         {
            _loc2_ = var_892[var_53];
