package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_440:ToolbarBarMenuAnimator;
      ...
      {
         return var_765.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1344.length)
         {
            _loc2_ = var_765.indexOf(var_1344[_loc4_]);
            if(_loc2_ > -1)
            {
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_440);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_765.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_321[var_765.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_2203.elements("menu");
         var _loc5_:int = 0;
