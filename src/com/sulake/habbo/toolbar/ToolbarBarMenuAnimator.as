package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1078:Number = 90;
      
      private static const const_803:int = 50;
      
      private static const const_1079:Number = 25;
      
      private static const const_1137:int = 50;
      
      private static const const_199:Boolean = true;
       
      
      private var var_624:Timer;
      
      private var var_1067:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1067 = param2;
         var_624 = new Timer(const_1079);
         var_624.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_525.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_525.splice(_loc3_,1);
            var_524.splice(_loc3_,1);
         }
         var_524.push(param1.name);
         var_525.push(param2);
         param1.addEventListener(WindowEvent.const_467,windowEventListener);
         param1.addEventListener(WindowEvent.const_208,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_525[var_524.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1067.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1067.getIconLoc(param1.iconId);
      ...
      {
         return var_524[var_525.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_625[_loc3_] = new Array();
            }
            if(var_625[_loc3_].indexOf(param1) < 0)
            {
               var_625[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_803 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_803 || param1.desktop.height - param1.y < const_1137;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_524[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_625[_loc3_].length)
                  {
                     repositionWindow(var_625[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
