package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_484:
               ...
               switch(_loc2_.queueSetTarget)
               {
                  case RoomSessionQueueEvent.const_927:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_883:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc7_.length > 1)
               {
                  ...
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1233) + 1;
                  }
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_758);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_883);
               break;
            case RoomWidgetRoomQueueMessage.const_565:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_927);
               break;
            case RoomWidgetRoomQueueMessage.const_758:
               if(false)
               {
      ...
      {
         return [RoomSessionQueueEvent.const_484];
      }
