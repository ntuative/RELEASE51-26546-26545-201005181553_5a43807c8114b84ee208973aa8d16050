package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_109:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_695,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_531];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_531:
      ...
      {
         return [RoomSessionDoorbellEvent.const_109,RoomSessionDoorbellEvent.const_128,RoomSessionDoorbellEvent.const_58];
      }
