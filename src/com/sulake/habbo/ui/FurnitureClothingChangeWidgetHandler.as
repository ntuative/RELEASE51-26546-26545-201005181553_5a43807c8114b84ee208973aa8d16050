package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1108:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      
      private static const const_1107:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         _container.roomSession.sendUpdateClothingChangeFurniture(var_154,param2,param1);
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_601,RoomWidgetClothingChangeMessage.const_305,RoomWidgetAvatarEditorMessage.const_354];
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetClothingChangeMessage.const_305:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     var_154 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_917);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1107;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_906);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1108;
                        }
                     }
                     if(_container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_214,AvatarEditorFigureCategory.const_550],true))
                     {
                        _loc11_ = 0;
