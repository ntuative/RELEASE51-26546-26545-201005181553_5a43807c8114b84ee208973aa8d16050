package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_526:Point = null;
      
      private var var_744:Map = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_368 != null)
         {
            ...
            {
               _loc2_ = var_368.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_368.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_744.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_368.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_744.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_682,RoomWidgetChatSelectAvatarMessage.const_532];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_682:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_153,_container.roomSession,0,"Version 26546-26545-201005181452");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_532:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_526 == null)
            {
               ...
               var_527.y = 0;
               var_527.z = 0;
               var_526 = _loc4_.getScreenPoint(var_527);
            ...
            var_527.y = 0;
            var_527.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_527);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_526.x || _loc8_.y != var_526.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_526,_loc5_));
