package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_652);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_526);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_119:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_652:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_526:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_119);
