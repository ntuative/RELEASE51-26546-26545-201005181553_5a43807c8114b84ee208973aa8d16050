package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_915:IRoomWidgetFactory;
      ...
      private var var_596:IAvatarRenderManager;
      
      private var var_275:Map;
      
      private var var_204:IHabboToolbar;
      
      private var var_758:IHabboModeration;
      ...
      {
         var_1086 = RoomDesktop.const_419;
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_113:
               if(param1.session != null)
               {
                  ...
                  var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.ZOOM));
                  var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.MEMENU));
                  var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_274.events.addEventListener(AdEvent.const_413,adEventHandler);
            var_274.events.addEventListener(AdEvent.const_398,adEventHandler);
            var_274.events.addEventListener(AdEvent.const_483,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_915 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_915 != null)
         {
            var_915.release(new IIDHabboRoomWidget());
            var_915 = null;
         }
         if(var_11 != null)
         {
         ...
         if(var_596 != null)
         {
            var_596.release(new IIDAvatarRenderManager());
            var_596 = null;
         }
         if(_catalog != null)
         {
         ...
         if(var_758 != null)
         {
            var_758.release(new IIDHabboModeration());
            var_758 = null;
         }
         if(_navigator != null)
         {
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_758 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_758);
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_557:
               ...
               if(var_1086 != RoomDesktop.const_419)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_281,var_1086);
               }
               if(var_274 != null)
               {
                  var_274.showRoomAd();
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_228:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_757:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_761,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_557,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_582,roomEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_734,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_502,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_405,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_457,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_596 = param2 as IAvatarRenderManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_19)
         {
            var_19.events.addEventListener(RoomSessionEvent.const_342,roomSessionStateEventHandler);
            var_19.events.addEventListener(RoomSessionEvent.const_98,roomSessionStateEventHandler);
            var_19.events.addEventListener(RoomSessionEvent.const_113,roomSessionStateEventHandler);
            ...
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_889,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_935,roomSessionDialogEventHandler);
            ...
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_757,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_648,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_183,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_596,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionErrorMessageEvent.const_617,roomSessionDialogEventHandler);
            var_19.events.addEventListener(RoomSessionQueueEvent.const_484,roomSessionEventHandler);
            var_19.events.addEventListener(RoomSessionVoteEvent.const_137,roomSessionEventHandler);
            ...
            var_19.events.addEventListener(RoomSessionDimmerPresetsEvent.const_377,roomSessionEventHandler);
            var_19.events.addEventListener(RoomSessionFriendRequestEvent.const_119,roomSessionEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_761)
         {
            if(var_19 != null)
            {
               var_19.roomEngineReady = true;
