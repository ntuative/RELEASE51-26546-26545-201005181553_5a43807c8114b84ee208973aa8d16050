package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_754,RoomWidgetEcotronBoxOpenMessage.const_629,RoomWidgetEcotronBoxOpenedMessage.const_1402];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_754:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_629:
