   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_821,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_681,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               ...
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_111,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_681,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_854,onAvatarEffectsChanged);
         ...
         if(false)
         {
            ...
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_111,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_111:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_111));
               break;
            case HabboHelpTutorialEvent.const_427:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_460));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_684);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_543);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_548);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_650);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_621);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_762);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_599);
         _loc1_.push(RoomWidgetStopEffectMessage.const_664);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1295);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_968);
         _loc1_.push(RoomWidgetToolbarMessage.const_696);
         _loc1_.push(RoomWidgetToolbarMessage.const_566);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_354);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1188);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_863);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_590);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_568);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_564);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1359);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_561);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_572);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_665);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_525));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_753:
               ...
               break;
            case RoomWidgetDanceMessage.const_684:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_543:
               if(var_11 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_548:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_650:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_599:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_762:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_956:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_870:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1400:
            ...
            case RoomWidgetStopEffectMessage.const_664:
            ...
            case RoomWidgetNavigateToRoomMessage.const_968:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_590:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_566:
               ...
               if(var_204 && false)
               {
                  var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_416,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_354:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_564:
            ...
            case RoomWidgetStoreSettingsMessage.const_572:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_322,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_665:
               if(false && _container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_305:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_573));
               break;
            default:
