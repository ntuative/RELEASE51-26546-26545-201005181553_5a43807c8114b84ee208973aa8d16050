      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_377:
               ...
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_662);
            ...
            case RoomEngineObjectEvent.const_95:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_660));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_524,RoomWidgetDimmerSavePresetMessage.const_533,RoomWidgetDimmerChangeStateMessage.const_756,RoomWidgetDimmerPreviewMessage.const_717];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_524:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_533:
               if(validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_756:
               if(validateRights())
               {
