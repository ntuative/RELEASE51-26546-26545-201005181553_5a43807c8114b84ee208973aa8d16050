package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_915:IRoomWidgetFactory = null;
      ...
      private var var_596:IAvatarRenderManager = null;
      ...
      private var var_186:IToolTipWindow;
      
      private var var_363:ISessionDataManager = null;
      
      private var var_2291:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_317,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_400,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_737,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_783 = _roomEngine.loadRoomResources(var_39.roomResources);
            if(false)
            {
               var_1390 = false;
         ...
         {
            var_1391 = !var_274.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_39.roomId,var_39.roomCategory,var_290[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_458 != null)
         {
            ...
            {
               _loc5_ = var_458.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_317,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_400,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_737,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_19 = null;
         var_915 = null;
         ...
         if(var_204 && false)
         {
            ...
            var_204.events.removeEventListener(HabboToolbarEvent.const_61,onHabboToolbarEvent);
         }
         var_204 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2291);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_458.length)
         {
            _loc2_ = var_458.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_204 != null)
         {
            var_185.toolbarSize = var_204.size;
            var_185.toolbarOrientation = var_204.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_290[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_186 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_186.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_915.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.ROOM_OBJECT_SELECTED:
               ...
               if(var_758 != null && _loc3_ == RoomObjectCategoryEnum.const_38)
               {
                  _loc7_ = var_39.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_315)
                  {
                     var_758.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_496:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_243,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_405:
               ...
               break;
            case RoomEngineObjectEvent.const_457:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_610);
            _loc13_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_555);
            _loc14_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_594);
            _loc15_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_606);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_318);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_457:
               ...
               var_186 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_310,WindowStyle.const_338,WindowParam.const_91) as IToolTipWindow;
               var_186.setParamFlag(WindowParam.const_49,false);
               var_186.visible = true;
               var_186.center();
               break;
            case RoomEngineObjectEvent.const_429:
               if(var_186 == null)
      ...
      {
         if(var_19 != null && var_39 != null && var_1391 && var_1390)
         {
            var_19.startSession(var_39);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_285));
         }
      }
      ...
      {
         if(var_783 == null || false)
         {
            return;
         }
         var _loc2_:int = var_783.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
