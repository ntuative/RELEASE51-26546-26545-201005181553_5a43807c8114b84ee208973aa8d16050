package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_643);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1016);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1014);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_618);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_211)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_680);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1184;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1039;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1393);
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_685);
         _loc1_.push(RoomWidgetFurniActionMessage.const_727);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_539);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1173);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_431)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_740:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_955,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_678:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_685:
            ...
            case RoomWidgetFurniActionMessage.const_266:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_727:
            ...
            case RoomWidgetUserActionMessage.const_494:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_539:
