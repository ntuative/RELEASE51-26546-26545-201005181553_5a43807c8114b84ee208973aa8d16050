package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1738:String = "room_widget";
      
      private const const_1158:String = "room_view";
      
      private var var_56:IWindowContainer;
      
      private var var_778:int = 50;
      
      private var var_2374:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_56.getChildByTag(const_1158) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_56.findChildByTag(const_1158) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_778;
               _loc2_.width = var_56.desktop.width - var_778;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_778;
               _loc2_.height = var_56.desktop.height - var_778;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_56.desktop.width;
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1738) == 0)
            {
