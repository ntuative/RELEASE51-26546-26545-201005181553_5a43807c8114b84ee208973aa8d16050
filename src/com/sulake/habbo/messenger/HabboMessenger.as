package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_640:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_322:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_897,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_640.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_640.setSelected(_loc2_);
            var_322.openMessenger();
            var_322.refresh(true);
         }
      }
      ...
      {
         var_640.addMessageAndUpdateView(param1);
         if(!var_322.isMessengerOpen())
         {
      ...
      {
         var_640 = new Conversations(new ConversationsDeps(this));
         var_322 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_640.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_640.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var_640.addMessageAndUpdateView(_loc3_);
      }
