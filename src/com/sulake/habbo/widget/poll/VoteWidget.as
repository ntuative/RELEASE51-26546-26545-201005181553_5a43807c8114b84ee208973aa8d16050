package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1330:int = 30000;
      
      private var var_1331:Boolean = false;
      
      private var var_1090:Array = null;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1330 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_137,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_127,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_327,update);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1958;
         if(_loc2_ > var_1330)
         {
            vote();
            return;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_137,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_127,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_327,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1330 - param1) / 1000,0);
