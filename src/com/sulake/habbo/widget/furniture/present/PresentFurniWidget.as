package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1082:Number = 100;
      
      private static const const_1084:Number = 100;
       
      
      private var var_228:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_378,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_421,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_375,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_374,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_378,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_421,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_375,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_374,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomWidgetPresentDataUpdateEvent.const_421:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_375:
               if(!var_228)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_374:
               if(!var_228)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_378:
               if(!var_228)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_615,var_154);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1082,const_1084,2,2),null,0) as IWindowContainer;
