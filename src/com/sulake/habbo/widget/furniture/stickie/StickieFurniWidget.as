package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_394,var_154,var_200,var_683);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_707,var_154);
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         var_1446 = param1.objectType;
         var_200 = param1.text;
         var_683 = param1.colorHex;
      ...
      private function sendUpdate() : void
      {
         ...
         if(messageListener != null)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_394,var_154,var_200,var_683);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_window == null)
         {
            _window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1082,const_1084,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null)
         {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + var_683);
            }
         ...
         setColorButtons(var_29 && var_1446 == "post_it");
      }
