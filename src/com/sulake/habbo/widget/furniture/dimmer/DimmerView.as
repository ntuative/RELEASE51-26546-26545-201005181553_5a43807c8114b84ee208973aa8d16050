package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1227:XML;
      
      private var var_413:int;
      
      private var var_509:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1082,const_1084,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_509 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_509 != null)
         {
            var_509.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1032 = _loc2_.light;
         if(var_359 != null)
         {
            var_359.setValue(var_1032);
         }
         var_413 = colors.indexOf(_loc2_.color);
         if(var_509 != null)
         {
            var_509.setSelectedColorIndex(var_413);
         }
