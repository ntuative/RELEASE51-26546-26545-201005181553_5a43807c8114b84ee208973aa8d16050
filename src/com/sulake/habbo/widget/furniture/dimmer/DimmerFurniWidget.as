package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_662,onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_660,onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         var_1721 = param1.presetId;
         var_990 = param1.effectId;
         _color = param1.color;
         var_991 = param1.brightness;
         if(_view != null)
         {
            _view.update();
         }
         if(!validateBrightness(var_991,var_990))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(_color,var_991,var_990 == 2);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var_812 = param1.selectedPresetId - 1;
         _presets = new Array();
         var _loc2_:int = 0;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(_color,var_991,var_990 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_662,onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_660,onHide);
         param1.removeEventListener(RoomWidgetDimmerStateUpdateEvent.const_60,onDimmerState);
      }
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         var _loc6_:DimmerFurniWidgetPresetItem = _presets[var_812] as DimmerFurniWidgetPresetItem;
