package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_741,var_884);
      ...
      {
         hideInterface();
         var_884 = param1.objectId;
         var_1272 = param1.creditValue;
         showInterface();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetCreditFurniUpdateEvent.const_623,onObjectUpdate);
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(var_1272));
         ...
         _window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1082,const_1084,2,2),null,0) as IWindowContainer;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetCreditFurniUpdateEvent.const_623,onObjectUpdate);
      }
   }
}
