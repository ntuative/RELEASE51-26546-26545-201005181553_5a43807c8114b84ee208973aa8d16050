package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1139:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_2117 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2115 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_757 = new Timer(1000,1);
         var_757.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_914 = new Timer(5000,1);
         var_914.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_141,method_10);
         _window.addEventListener(WindowEvent.const_467,onWindowMoved);
         var_1318 = true;
         var_139 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2116 = _loc2_.width + const_517 + _loc6_.width + const_1138;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1139,_loc8_.width) + const_517);
            _loc8_.x = _loc12_;
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_531);
