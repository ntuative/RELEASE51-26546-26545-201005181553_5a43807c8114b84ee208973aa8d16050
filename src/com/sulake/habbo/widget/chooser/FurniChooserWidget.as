package com.sulake.habbo.widget.chooser
{
   ...
   public class FurniChooserWidget extends ChooserWidgetBase
   {
      ...
      private var var_532:ChooserView;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_718,onChooserContent);
      ...
      {
         if(var_532 == null || !var_532.isOpen())
         {
            return;
         }
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         if(var_532 == null)
         {
            var_532 = new ChooserView(this,"${widget.chooser.furni.title}");
         }
         var_532.populate(param1.items,param1.isAnyRoomController);
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_718,onChooserContent);
