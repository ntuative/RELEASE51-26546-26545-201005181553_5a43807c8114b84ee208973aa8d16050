package com.sulake.habbo.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_1720:int = 0;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_639,onChooserContent);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_260,onUpdateUserChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_545,onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_639,onChooserContent);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_260,onUpdateUserChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_545,onUpdateUserChooser);
      }
