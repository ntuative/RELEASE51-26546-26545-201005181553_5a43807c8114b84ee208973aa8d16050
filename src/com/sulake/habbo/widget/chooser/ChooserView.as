package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1444:uint = 0;
      ...
      private const const_1706:uint = 4.282169599E9;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1424);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_666)
         {
            return;
         }
         if(var_666 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_666) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_666 % 2) ? uint(const_1444) : uint(const_1443);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1706;
            var_666 = param1;
         }
      }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1444) : uint(const_1443);
