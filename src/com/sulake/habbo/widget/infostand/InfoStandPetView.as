package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1731:String = "level";
      
      private var var_109:IItemListWindow;
      
      private const const_1729:String = "energy";
      
      private var var_1163:Map;
      
      private const const_1733:String = "nutrition";
      
      private var var_64:IItemListWindow;
      
      private const const_1735:uint = 3355443;
      
      private var var_244:IBorderWindow;
      
      private const const_1732:int = 158;
      
      private const const_1728:int = 16;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_244 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_244 != null)
         {
            var_109 = var_244.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_244.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_244.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_109 == null || var_244 == null || var_64 == null)
         {
            return;
         }
         ...
         var_244.height = NaN;
         _window.width = Math.max(var_244.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1163.getValue(var_594) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1731,param1.level,param1.levelMax);
         updateStateElement(const_1734,param1.experience,param1.experienceMax);
         updateStateElement(const_1729,param1.energy,param1.energyMax);
         updateStateElement(const_1733,param1.nutrition,param1.nutritionMax);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_184 && var_184.getPetId() == var_594)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_442,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1732,const_1728,false);
         ...
         _loc5_.fillRect(_loc6_,const_1735);
