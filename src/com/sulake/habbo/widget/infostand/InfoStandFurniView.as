package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      {
         var _loc2_:ITextWindow = var_109.getListItemByName("expiration_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_109.getListItemByName("expiration_spacer") as IWindowContainer;
