package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1445:String = "infostand_user_view";
      ...
      private const const_1447:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1448:String = "infostand_pet_view";
      
      private const const_1446:String = "infostand_furni_view";
      
      private const const_1709:int = 3000;
      
      private var var_190:InfoStandUserView;
      
      private var var_403:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_793 = new InfoStandFurniView(this,const_1446);
         var_190 = new InfoStandUserView(this,const_1445);
         var_295 = new InfoStandPetView(this,const_1448);
         var_336 = new InfoStandBotView(this,const_1447);
         var_403 = new InfostandUserData();
         var_394 = new InfostandFurniData();
         var_1163 = new InfoStandPetData();
         var_123 = new Timer(const_1709);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_190.setTags(param1.tags,var_1650);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_243,onClose);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_643,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_612,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_494,var_295.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_243,onClose);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_643,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_612,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_260:
               ...
               {
                  _loc2_ = param1.id == var_403.userRoomId;
                  break;
               }
