package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_367:int = 10;
      
      private static const const_1147:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_1101,var_1102,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1101,var_763,var_1102,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1336 = param1.chatType;
         var_1101 = param1.userId;
         var_763 = param1.userName;
         var_1102 = param1.userCategory;
         _message = param1.text;
         var_1338 = param1.userX;
         var_208 = param1.userImage;
         var_1103 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_102,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         if(var_208 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_446 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1103 != 0)
            {
               _loc30_ = uint(var_1103 >> 16 & 255);
               _loc31_ = uint(var_1103 >> 8 & 255);
               _loc32_ = uint(var_1103 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_367;
            }
            else
            {
               _loc19_.text = var_763 + ":";
               _loc19_.y += var_446;
               _loc19_.width = _loc19_.textWidth + const_367;
               _width += _loc19_.textWidth + const_367;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1336 == RoomWidgetChatUpdateEvent.const_274)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_763);
            }
            else if(var_1336 == RoomWidgetChatUpdateEvent.const_286)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_763);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_367 + _loc20_.textWidth + const_517;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1101,var_1102,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1101,var_1102,_roomId,_roomCategory,param1);
      }
