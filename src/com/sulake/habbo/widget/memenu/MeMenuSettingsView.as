package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1444 = (_loc5_.content as BitmapData).clone();
         }
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_564));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_682 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1444);
               }
               break;
            case "sounds_on":
               if(var_682 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1443);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1442);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1444);
