package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_650,param1.effect.type));
         }
         else
         {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "moreEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_956));
               break;
            case "hideEffects_btn":
               _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_621));
               break;
            default:
      ...
      public function include(param1:Array) : Boolean
      {
         var _loc3_:* = null;
         var _loc4_:int = 0;
