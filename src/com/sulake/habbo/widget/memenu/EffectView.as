   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_924 = _window.findChildByName("effect_hilite");
            var_924.visible = false;
         }
         var_925 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_923 = _window.findChildByName("loader_bar");
         if(var_923 != null)
         {
            var_436 = var_923.width;
            var_170.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_925 != null)
         {
            var_925.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_925.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
