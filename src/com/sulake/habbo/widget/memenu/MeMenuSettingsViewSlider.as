package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_864:MeMenuSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_864.saveVolume(getValue(param2.x),false);
      }
      ...
      {
         return int(var_1496 * (Number(param1 - var_714) / (var_1039 - var_714)));
      }
      ...
      {
         return param1 / var_1496 * (var_1039 - var_714) + var_714;
      }
   }
}
