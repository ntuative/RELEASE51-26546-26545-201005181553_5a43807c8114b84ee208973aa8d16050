package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_506:String = "tab_girl";
      
      private const const_505:String = "tab_boy";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(_model.controller.gender)
         {
            case FigureData.const_71:
               activateTab(const_505);
               inactivateTab(const_506);
               break;
            case FigureData.const_74:
               activateTab(const_506);
               inactivateTab(const_505);
         }
      }
