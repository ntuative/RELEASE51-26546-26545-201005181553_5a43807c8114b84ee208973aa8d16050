package com.sulake.habbo.avatar.palette
{
   ...
   public class PaletteMap
   {
      ...
      {
         param1.paletteMap(param1,param1.rect,new Point(0,0),_blank,var_542,_blank,_blank);
      }
      ...
      public function colorize(param1:ByteArray) : ByteArray
      {
         ...
         while(param1.bytesAvailable >= 4)
         {
            ...
            _loc7_ = uint(var_542[_loc5_] as uint);
      ...
      {
         var _loc2_:int = var_542.indexOf(param1);
