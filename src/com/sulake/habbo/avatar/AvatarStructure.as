package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1555:PartOffsetData;
      
      private var var_908:AvatarActionManager;
      
      private var var_179:IAssetLibrary;
      
      private var var_907:IAssetLibrary;
      
      private var var_2101:AvatarRenderManager;
      
      private var var_315:FigureData;
      
      private var var_573:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_751:String;
      
      private var var_1554:AvatarStructureDownloadSet;
      
      private var var_1315:Array;
      
      private var var_750:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_573 = new AnimationData();
         var_1554 = new AvatarStructureDownloadSet();
         var_750 = new AnimationManager();
         var_751 = param4;
         var_1555 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_908.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_751)
         {
            case AvatarType.const_86:
               _loc1_ = var_179.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_439.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_179.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_573.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_179.getAssetByName("HabboAvatarFigure").content as XML;
               ...
               break;
            case AvatarType.PET:
               _loc1_ = var_179.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_439.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_179.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_573.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_179.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_315.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_908.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_908.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_750.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1171[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_908.getDefaultActionType();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_750.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
               ...
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_573.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_751 + " ready to go!");
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_86:
               if(var_179.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_179.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_179.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_179.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_86:
               if(var_179.hasAsset(_loc5_))
               {
                  var_179.removeAsset(var_179.getAssetByName(_loc5_));
               }
               var_1554.add(new AvatarStructureDownload(var_179,_loc5_,var_315));
               break;
            case AvatarType.PET:
         }
         var_1554.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_750.getAnimation(param1);
      }
      ...
      {
         var_908 = new AvatarActionManager(var_179,var_751);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_907.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_907.getAssetByName("dance" + _loc1_).content as XML;
            var_750.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_907.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_907.getAssetByName("fx" + _loc1_).content as XML;
            var_750.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         var_1555.loadOffsets(var_907);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_908.sortActions(param1);
      }
   }
}
