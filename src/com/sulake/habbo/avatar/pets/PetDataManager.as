package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private const const_1712:int = 0;
      
      private var var_136:AvatarRenderManager;
      
      private const const_369:int = 2;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               var_476.add(_loc4_,new PetData(_loc3_));
            }
         }
      }
      ...
      {
         var _loc4_:PetData = var_476.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = var_248.indexOf(_loc2_);
         if(_loc3_ >= 0)
         {
      ...
      private function notifyListeners() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_673.pop() as IPetDataListener;
            if(_loc1_ != null)
            {
               _loc1_.petDataReady();
            }
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_476.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_476.getValue(key);
            if(petData != null)
            {
      ...
      {
         var _loc3_:IPetData = var_476.getValue(param1) as IPetData;
