package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1467:int = 60000;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_593)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_445)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_51.getParts(param1,(var_823 as AvatarImage).getFigure(),_loc6_,var_1292,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_51.getCanvas(var_146,var_1292);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1334[param1])
            {
            ...
            else
            {
               ...
               if((_loc29_ == AvatarAction.const_1036 || _loc29_ == AvatarAction.const_547) && (_loc6_ == AvatarBodyPartType.const_214 || _loc6_ == AvatarBodyPartType.const_1228 || _loc6_ == AvatarBodyPartType.const_1376) && _loc7_.color != null)
               {
