package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_2078 = parseInt(param1.@precedence);
         var_2079 = String(param1.@activepartset);
         var_2076 = String(param1.@assetpartdefinition);
         var_2080 = String(param1.@lay);
         var_1292 = String(param1.@geometrytype);
         var_1833 = Boolean(parseInt(param1.@main));
         var_2075 = Boolean(parseInt(param1.@method_11));
         var_2077 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1164 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(var_574.getValue(param1) == null)
         {
            var_574.add(param1,new Map());
         }
         var _loc4_:Map = var_574.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_574.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1164.concat(getTypePrevents(param1));
      }
