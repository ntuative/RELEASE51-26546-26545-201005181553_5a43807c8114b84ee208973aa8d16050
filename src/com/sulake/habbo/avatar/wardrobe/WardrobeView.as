package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_1107:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_768 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1107 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_768)
         {
            var_768.removeListItems();
         }
         if(var_1107)
         {
            var_1107.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_768)
               {
                  var_768.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1107)
            {
               var_1107.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
