package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1099:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1100:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
       
      
      private var _view:AvatarEditorView;
      
      private var var_842:AvatarEditorHandler;
      ...
      private const const_1101:int = 2;
      ...
      private var var_1023:IHabboAvatarEditorDataSaver = null;
      ...
      private function init() : void
      {
         ...
         if(!var_168)
         {
            ...
            _loc1_ = var_504["null"];
            _loc2_ = var_504["null"];
            _loc1_.loadAvatarData(const_1099,FigureData.const_71);
            _loc2_.loadAvatarData(const_1100,FigureData.const_74);
            var_91 = new Map();
            var_410 = new Map();
            var_91.add(AvatarEditorFigureCategory.const_729,new BodyModel(this));
            var_91.add(AvatarEditorFigureCategory.const_47,new HeadModel(this));
            var_91.add(AvatarEditorFigureCategory.const_214,new TorsoModel(this));
            var_91.add(AvatarEditorFigureCategory.const_550,new LegsModel(this));
            var_91.add(AvatarEditorFigureCategory.const_983,new HotLooksModel(this));
            var_410.add(AvatarEditorSideCategory.const_100,new WardrobeModel(this));
            var_410.add(AvatarEditorSideCategory.CLUB_PROMO,new ClubPromoModel(this));
            var_168 = true;
         }
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1023 != null)
         {
            ...
            _loc2_ = "null";
            var_1023.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1024 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1482;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1024 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1101)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1632.clone() as IWindowContainer,param1,_loc14_);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1297)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1024 >= _loc6_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_410.getValue(AvatarEditorSideCategory.const_100);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_842 = new AvatarEditorHandler(this,_communication);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_410.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
      ...
      {
         var_702 = var_596.getFigureData(AvatarType.const_86);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_596 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
