package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2071:uint;
      
      private var _rgb:uint;
      
      private var var_1069:Map;
      
      private var var_1604:Number = 1;
      
      private var _b:uint;
      
      private var var_1602:Number = 1;
      ...
      private var var_2070:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_2071 = parseInt(_loc2_,16);
         var_2069 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1601,var_1602,var_1604,_alphaMultiplier);
         var_1069 = generatePaletteMapForGrayscale(var_2069,var_2071);
      }
