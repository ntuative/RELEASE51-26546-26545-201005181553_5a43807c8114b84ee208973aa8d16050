package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_833 = new Vector3D(0,0,10,0);
         super();
         var_501 = new Matrix4x4();
         var_695 = new Dictionary();
         var_1461 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            var_695[String(_loc4_.@id)] = _loc12_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(var_501,var_833,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1461.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_695[param1] as Dictionary;
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         for each(_loc8_ in _loc6_)
         {
            ...
            _loc11_ = _loc8_.getDistance(var_833);
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_695[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1461.findAvatarSet(param1);
         if(_loc3_ != null)
         {
