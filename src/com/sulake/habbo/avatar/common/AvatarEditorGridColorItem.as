package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_735:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_694.width,var_694.height,true,0);
            _loc1_.bitmap.copyPixels(var_694,var_694.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_888.width,var_888.height,true,0);
            _loc5_ = var_888.clone();
            _loc5_.colorTransform(_loc5_.rect,var_735.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_736.width,var_736.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_736,var_736.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
