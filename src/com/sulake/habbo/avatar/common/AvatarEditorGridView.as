package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_510 = _view.findChildByName("part_thumbs") as IItemGridWindow;
            var_414 = new Array();
         ...
         if(param1.type == WindowMouseEvent.const_54)
         {
            ...
            while(_loc7_ < const_1101)
            {
               if(var_414.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     _model.selectColor(var_1229,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = _model.getCategoryData(var_1229);
         if(!_loc1_)
         {
            return;
         }
         ...
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               var_510.addGridItem(_loc2_.view);
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_54)
         {
            _loc3_ = var_510.getGridItemIndex(param1.window);
            _model.selectPart(var_1229,_loc3_);
         }
      }
