package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1122:String = "badges";
      
      private static const const_1127:String = "pet_inventory";
      
      private static const const_1120:String = "pixelbalance";
      
      private static const const_1121:String = "credits";
      
      private static const const_1123:String = "inventory";
      
      private static const const_1124:String = "friendlist";
      ...
      private var var_613:IHabboToolbar;
      ...
      private var var_728:ClubEndingNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_877);
         }
         var _loc6_:Map = var_877["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1302);
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_613)
         {
            var_613.release(new IIDHabboToolbar());
            var_613 = null;
         }
         if(_windowManager)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1396);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1993)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_839);
            var_1993 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1127:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_156);
               }
               break;
            case const_1125:
               break;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_839,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_596.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_952,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_192 || param2.type == WindowEvent.const_571)
         {
            param1.dispose();
         }
      }
      ...
      {
         var _loc1_:Array = var_1053.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_596.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1323,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_596.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1053.push(_loc8_);
         return var_1053.length;
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1227)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_728 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_613 = IHabboToolbar(param2);
         var_613.events.addEventListener(HabboToolbarEvent.const_90,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_363.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_918);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_918);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_90)
         {
            ...
            var_428 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_877["styles"],var_877["view"],var_613);
            ...
            var_363.events.addEventListener(BadgeImageReadyEvent.const_140,onBadgeImage);
            var_613.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
