package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1658 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_363 != null)
         {
            var_363.events.removeEventListener(BadgeImageReadyEvent.const_140,onBadgeImageReady);
            var_363 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_669,var_1658);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_669,var_669));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_669,var_669));
         _localizations.registerParameter(param1,"level",var_1659.toString());
