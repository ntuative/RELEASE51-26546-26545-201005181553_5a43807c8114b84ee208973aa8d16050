package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_577);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_959);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_544);
         }
      ...
      private function method_5(param1:RoomObjectStateChangeEvent, param2:int, param3:int) : void
      {
         if(param1 == null)
         {
            return;
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_38 && _loc3_.typeId == RoomObjectTypeEnum.const_340)
               {
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_239,param2);
         }
      }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_34)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_544);
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = getMouseEventId(RoomObjectCategoryEnum.const_242,MouseEvent.CLICK);
         switch(_loc4_)
         {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_67)
         {
            ...
            if(_loc12_ != _loc10_)
            {
               ...
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_496,param2,param3,-1,RoomObjectCategoryEnum.const_242));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_34 || _loc8_ == RoomObjectCategoryEnum.const_32)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_734,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_499);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_254:
               ...
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_370:
               _loc7_ = "null";
               break;
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectMouseEvent.const_410:
               ...
               break;
            case RoomObjectMouseEvent.const_396:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = _roomEngine.getRoomObject(roomId,roomCategory,var_1095,category) as IRoomObjectController;
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_401));
            }
         }
      }
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_379:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_459:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_499);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
      ...
      {
         var _loc3_:Map = var_634.getValue(String(param1)) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:Map = var_634.getValue(String(param1)) as Map;
         if(_loc4_ == null)
         {
            _loc4_ = new Map();
            var_634.add(param1,_loc4_);
         }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_164:
               method_5(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_763:
            ...
            case RoomObjectMoveEvent.const_406:
               ...
               break;
            case RoomObjectMoveEvent.const_390:
            ...
            case RoomObjectFurnitureActionEvent.const_376:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_412:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_1012));
               break;
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_STOP:
