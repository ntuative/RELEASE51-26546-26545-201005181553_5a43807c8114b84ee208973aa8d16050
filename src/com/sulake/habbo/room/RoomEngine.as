package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private var var_651:NumberBank;
      ...
      private var var_784:RoomMessageHandler = null;
      
      private var var_785:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_327 = new Map();
         var_651 = new NumberBank(1000);
         var_1121 = new Map();
         var_326 = new Map();
         var_68 = new RoomObjectEventHandler(this);
         var_784 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_68 != null)
         {
            ...
            {
               return var_68.deleteWallItem(var_121,var_120,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_327.length; _loc2_++)
         {
            _loc3_ = var_327.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           ...
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_594) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_555) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_606) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_68 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_68.modifyWallItemData(var_121,var_120,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_785 != null)
         {
            var_785.release(new IIDRoomRendererFactory());
            var_785 = null;
         }
         ...
         if(var_327 != null)
         {
            ...
            {
               _loc2_ = var_327.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_785.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_893;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_605);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_628);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_654);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_945);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_820);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_864) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_886);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_465,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_552,var_121,var_120,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_68 != null)
         {
            return var_68.modifyRoomObject(var_121,var_120,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_326.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_326.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_751,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_42 != null)
         {
            ...
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_67);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_68 != null)
         {
            var_68.handleRoomObjectEvent(param1,var_121,var_120);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_318,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_902,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1016,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1014,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_265,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      {
         if(var_27 == null || var_395 == null || var_42 == null || var_785 == null || _communication == null || _habboConfiguration == null || !var_2292)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_293,RoomObjectCategoryEnum.const_67);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_42.getRoom(getRoomIdentifier(var_121,var_120));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_819,RoomObjectCategoryEnum.const_270);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_120,var_1392);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_294);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_120,var_1392);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_294);
         }
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_27 != null)
         {
            if(false)
            {
               var_27.events.addEventListener(RoomObjectMouseEvent.const_221,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_410,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMouseEvent.const_396,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_164,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectStateChangeEvent.const_763,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_114,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_118,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectWidgetRequestEvent.const_95,roomObjectEventHandler);
               ...
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_485,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_391,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_385,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_412,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_STOP,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_376,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_463,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectFurnitureActionEvent.const_498,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_60,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_406,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectMoveEvent.const_390,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_254,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_370,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_321,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomAdEvent.const_330,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_379,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_925,roomObjectEventHandler);
               var_27.events.addEventListener(RoomObjectRoomActionEvent.const_459,roomObjectEventHandler);
               var_27.events.addEventListener(AvatarWalkWarpingWarningEvent.const_487,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_588) != 0)
         {
            return false;
         }
         if(var_68 != null)
         {
            return var_68.initializeRoomObjectInsert(var_121,var_120,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_555 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_761,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_326.length)
            {
               _loc3_ = var_326.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_265,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_441);
                     break;
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_722)
         {
            var_2292 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_318,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_893,1,true);
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_274.events.addEventListener(AdEvent.const_483,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_818) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_327.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_785 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_555 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_42.getRoom(const_519);
         if(_loc10_ == null)
         {
            _loc10_ = var_42.createRoom(const_519,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_651.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_441,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
            ...
            case RoomObjectCategoryEnum.const_67:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_627,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_546,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_522,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_465,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1121.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_849,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_651.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_817,RoomObjectCategoryEnum.const_270);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_294);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1624 - _loc12_.width / 2;
               _loc11_.y = var_1623 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_496,var_121,var_120,-1,RoomObjectCategoryEnum.const_242));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_68 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_293,const_520);
                  var_68.handleRoomObjectEvent(_loc14_,var_121,var_120);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_120,var_1392);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_294);
            _loc11_ = addOverlayIconSprite(_loc10_,const_294,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1624 - _loc6_.data.width / 2;
               _loc11_.y = var_1623 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_308,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_911,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_966,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_835,RoomObjectVariableEnum.const_308,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_327.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_327.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_722,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_68 != null)
         {
            var_68.cancelRoomObjectInsert(var_121,var_120);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_42.getRoom(const_519);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_849);
               ...
               var_651.freeNumber(_loc10_ - 1);
               _loc13_ = var_1121.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_121,var_120,const_293,RoomObjectCategoryEnum.const_67,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_588,1,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_293,const_520,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_588,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_605,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_555,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_594,_loc18_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_923,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_751,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_465,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_241);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_628,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_654,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_628,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_654,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_945,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_820,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_817,const_1170,RoomObjectCategoryEnum.const_270);
         _loc7_.createRoomObject(const_819,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_270);
         return _loc7_;
      }
