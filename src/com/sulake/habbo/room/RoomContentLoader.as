package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_806:String = "selection_arrow";
      
      private static const const_804:String = "tile_cursor";
      ...
      private static const const_365:String = "place_holder";
      
      private static const const_1140:String = const_365;
      
      private static const const_1469:int = 0;
      
      private static const const_805:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_722:String = "RCL_LOADER_READY";
      ...
      public function RoomContentLoader()
      {
         var_534 = [];
         _wallItems = [];
         var_2124 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_317,_loc4_);
      ...
      {
         if(var_181 != null && var_181.hasWorldType(const_292 + param1))
         {
            return var_181.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_371 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_371.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_630.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_365,const_516,ROOM_CONTENT,const_804,const_806];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2124.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_172 && _loc5_ != RoomObjectLogicEnum.const_129)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_631.getValue(param1) != null)
         {
            return var_631.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2121.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               ...
               var_1320.add(_loc5_,_loc8_);
               var_181 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_317,_loc5_);
         }
         else
         {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1178);
               return;
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2125)
         {
            ...
            if(var_1085 != null)
            {
               var_1085.dispatchEvent(new Event(const_722));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_181 != null)
         {
            return var_181.getWorldHeightScale(const_292 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1085 = param1;
         var_2120 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_2122 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_2123 = param2.getKey("public.room.dynamic.download.url","");
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_371.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_442 != null)
         {
            var_442.remove(param2);
            var_442.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_172 && _loc5_ != RoomObjectVisualizationEnum.const_129)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_292 + param1) == RoomObjectCategoryEnum.const_67)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1320.getValue(param1) != null)
         {
            var_181 = var_1320.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_456,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_181 != null)
         {
            return var_181.getWorldScale(const_292 + param1);
         }
         return 32;
      }
   }
