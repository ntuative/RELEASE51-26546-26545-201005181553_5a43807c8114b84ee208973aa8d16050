package com.sulake.habbo.room.utils
{
   ...
   public class LegacyWallGeometry implements IDisposable
   {
      ...
      private static const const_808:String = "l";
      ...
      public function getLocationOldFormat(param1:Number, param2:Number, param3:String) : IVector3d
      {
         ...
         while(_loc4_ < _width)
         {
            ...
            {
               if(getTileHeight(_loc4_,_loc5_) <= var_761)
               {
                  _loc8_ = _loc4_ - 1;
                  _loc9_ = _loc5_;
               ...
               if(getTileHeight(_loc4_,_loc5_ + 1) <= var_761)
               {
                  _loc8_ = _loc4_;
                  _loc9_ = _loc5_;
         ...
         if(param1 == 0 && param2 == 0)
         {
            ...
            if(param5 == DIRECTION_RIGHT)
            {
               ...
               while(_loc7_ >= 0)
               {
                  ...
                  {
                     if(getTileHeight(_loc7_,_loc6_) <= var_761)
                     {
                        if(_loc6_ - 1 < param2)
                        {
                           param1 = _loc7_;
