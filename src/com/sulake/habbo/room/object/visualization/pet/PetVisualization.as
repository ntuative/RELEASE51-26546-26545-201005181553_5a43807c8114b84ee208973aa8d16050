package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IAvatarImageListener
   {
      ...
      private var var_759:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc9_ > 0)
         {
            ...
            if(_loc16_ < AvatarAction.const_1011)
            {
               var_355.alpha = int(Math.sin(_loc16_ / 0 * 0) * 255);
               var_355.setExperience(_loc4_.getNumber(RoomObjectVariableEnum.const_1010));
               var_538 = const_1143;
            }
         }
         var _loc10_:Boolean = false;
         var _loc11_:String = _loc4_.getString(RoomObjectVariableEnum.const_269);
         switch(_loc11_)
         {
         ...
         var _loc12_:Boolean = var_292 != _loc3_.getUpdateID() || var_214 != param1.scale || var_166 != _loc4_.getUpdateID();
         var _loc13_:Boolean = var_398 || var_538 > 0 || _loc10_;
         if(_loc12_ || _loc13_)
         {
            increaseUpdateId();
            _loc17_ = getTimer();
            ...
            if(var_299 != _loc7_)
            {
               for each(var _loc51_ in var_256.getKeys())
               {
                  _loc31_ = _loc51_;
                  _loc51_;
                  var_256.remove(_loc31_);
               }
               var _loc49_:* = null;
               _loc6_ = null;
               _loc49_;
            ...
            if(_loc6_ == null)
            {
               _loc6_ = var_759.getAvatar(_loc7_,param1.scale,this);
               if(_loc6_ == null)
               {
                  return;
               }
               var_256.remove(_loc5_);
            ...
            _loc19_ = _loc4_.getNumber(RoomObjectVariableEnum.const_352);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc20_ = _loc4_.getString(RoomObjectVariableEnum.const_269);
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_709);
            _loc6_.appendAction(AvatarAction.const_746,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
               _loc32_ = int(_loc21_);
            ...
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_440);
            if(_loc23_ != null && _loc23_ != "")
            {
               _loc33_ = _loc4_.getNumber(RoomObjectVariableEnum.const_501);
               _loc34_ = 3;
               _loc35_ = param2 - _loc33_;
               if(_loc35_ < _loc34_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_295,_loc23_);
               }
            }
            _loc24_ = _loc4_.getNumber(RoomObjectVariableEnum.const_387) > 0;
            if(_loc24_)
            {
            ...
            _loc25_ = _loc6_.getSprites().length + const_775;
            ...
            {
               _loc49_ = _loc6_.getSprites().length + const_775;
               _loc25_ = _loc6_.getSprites().length + const_775;
               _loc49_;
               if(_loc25_ != spriteCount)
               {
               ...
               if(var_540)
               {
                  _loc49_ = var_540.content as BitmapData;
                  _loc26_.asset = var_540.content as BitmapData;
                  _loc49_;
            ...
            _loc26_ = getSprite(const_1718);
            if(false)
            {
               _loc26_.asset = var_355.image;
               _loc26_.offsetX = -20;
               _loc26_.offsetY = -80;
               _loc26_.alpha = var_355.alpha;
            ...
            var_837.push(getTimer() - _loc17_);
            if(false)
            {
               _loc46_ = 0;
               _loc47_ = "[";
               for each(_loc51_ in var_837)
               {
                  _loc48_ = _loc51_;
                  _loc51_;
      ...
      {
         var_759 = param1 as PetVisualizationData;
         createSprites(const_775);
         var_355 = new ExperienceData(var_759);
         return true;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_256 != null)
         {
            _loc1_ = var_256.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_256.getValue(_loc2_) as IAvatarImage;
            }
         }
         var_256.dispose();
         if(var_355)
