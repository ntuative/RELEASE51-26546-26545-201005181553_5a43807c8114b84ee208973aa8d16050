package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         var_729 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1356 = param3;
         var_1994 = param4 * 0 * 2 / 360;
      ...
      {
         var _loc3_:Number = var_1356 * Math.cos(var_879 + var_1520);
         var _loc4_:Number = var_1356 * Math.sin(var_879 + var_1520);
         var _loc5_:Number = _height;
         var_729.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_729.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_729.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_729.add(param1);
         }
