package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_868);
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_230 != null)
         {
            ...
            {
               _loc2_ = var_230[_loc3_];
               _loc2_.update(var_604,var_1925,param1);
               _loc3_++;
            }
