package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      {
         var _loc2_:AnimationData = var_360.getValue(param1) as AnimationData;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc6_:AnimationData = var_360.getValue(param2) as AnimationData;
         if(_loc6_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc4_:AnimationData = var_360.getValue(param2) as AnimationData;
         if(_loc4_ != null)
         {
      ...
      override public function dispose() : void
      {
         ...
         if(var_360 != null)
         {
            ...
            {
               _loc2_ = var_360.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
