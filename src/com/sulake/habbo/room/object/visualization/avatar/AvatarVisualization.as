package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_539:BitmapDataAsset;
      
      private const const_1143:int = 3;
      
      private const const_1718:int = 2;
      
      private var var_759:AvatarVisualizationData = null;
      ...
      {
         var_759 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_256.getValue(_loc5_) as IAvatarImage;
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_168);
         var _loc8_:Boolean = false;
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_713);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_567);
         ...
         var _loc13_:int = param2 - var_1325;
         ...
         var _loc15_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_343);
         if(_loc15_ > 0)
         {
         ...
         var _loc16_:Boolean = var_292 != _loc3_.getUpdateID() || var_214 != param1.scale || var_166 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_398 || var_538 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_538;
            ...
            if(var_299 != _loc7_)
            {
               for each(_loc40_ in var_256.getKeys())
               {
                  _loc41_ = var_256.getValue(_loc40_) as IAvatarImage;
                  if(_loc41_)
                  {
                     _loc41_.dispose();
                  }
                  var_256.remove(_loc40_);
               }
               if(_loc6_)
               {
                  _loc6_.dispose();
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_997);
               _loc6_ = var_759.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
               var_256.add(_loc5_,_loc6_);
               var_299 = _loc7_;
            }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_352);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_269) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_269);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_709);
            _loc6_.appendAction(AvatarAction.const_746,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_440);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_501);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_295,AvatarAction.const_1258[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_942);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_988,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1023);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_844);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_880,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_618);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_614);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_949,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_905,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_395);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_387) > 0;
            if(_loc31_ || _loc12_)
            {
               _loc6_.appendAction(AvatarAction.const_535);
            }
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_495);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1015);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_711,_loc32_);
            }
            ...
            if(_loc22_ == "mv" || _loc22_ == "std")
            {
               ...
               {
                  case 32:
                     var_540 = _loc6_.getAsset("sh_std_sd_1_0_0");
                     _loc65_ = -8;
                     _loc66_ = -3;
                     break;
                  case 64:
                     var_540 = _loc6_.getAsset("h_std_sd_1_0_0");
                     _loc65_ = -17;
                     _loc66_ = -7;
               }
               if(var_540 != null)
               {
                  _loc35_.asset = var_540.content as BitmapData;
            ...
            var_539 = null;
            _loc35_ = getSprite(const_1718);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_1013))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_539 = var_759.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_539 = var_759.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_539 != null)
               {
                  _loc35_.asset = var_539.content as BitmapData;
            ...
            var_837.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_837)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
