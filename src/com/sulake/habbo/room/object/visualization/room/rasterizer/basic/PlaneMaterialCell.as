package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_518:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_518 != null)
         {
            _loc2_ = var_518.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  ...
                  _loc3_ = Math.min(var_1058,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_1058,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_1058,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
