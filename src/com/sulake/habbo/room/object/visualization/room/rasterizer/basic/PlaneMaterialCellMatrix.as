package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1336:int = const_319;
      ...
      public static const const_738:int = 6;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1544 == const_105)
         {
            _loc5_ = new Rectangle(0,0,var_24.width,var_366);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_366,var_24.width,var_366);
         }
