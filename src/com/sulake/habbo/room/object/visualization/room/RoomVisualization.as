package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_781:int = 16777215;
      
      public static const const_1432:int = 10066329;
      
      private static const const_783:int = 13421772;
      
      public static const const_1207:int = 16777215;
      
      private static const const_1461:int = 0;
      
      public static const const_1266:int = 16777215;
      
      private static const const_782:int = 10066329;
      
      private static const const_780:int = 10066329;
      
      public static const const_1201:int = 13421772;
      ...
      private var var_1175:String = null;
      
      private var var_1735:int = -1000;
      
      private var var_1036:uint = 16777215;
      
      private var var_1910:Boolean = true;
      ...
      private var var_598:Rectangle = null;
      ...
      private var var_1912:String = null;
      
      private const const_1722:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_923);
         var _loc7_:int = 0;
         while(_loc7_ < var_77.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_144)
            {
               ...
               {
                  _loc13_.color = const_781;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_783;
               }
               else
               {
                  _loc13_.color = const_782;
               }
               if(_data != null)
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_202,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1409)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_205,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_205 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_598 == null)
         {
            var_598 = super.boundingRectangle;
         }
         return new Rectangle(var_598.x,var_598.y,var_598.width,var_598.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_416.maskCount)
         {
            _loc6_ = var_416.getMaskType(_loc5_);
            _loc7_ = var_416.getMaskLocation(_loc5_);
            _loc8_ = var_416.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_104.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_205 || _loc3_.type == RoomPlane.const_202 && _loc8_ == RoomPlaneBitmapMaskData.const_241)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1437;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1274)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1062 || _loc9_.y != var_1917 || _loc9_.z != var_1913 || param1.scale != var_1911))
            {
               var_1062 = _loc9_.x;
               var_1917 = _loc9_.y;
               var_1913 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_847);
            if(_loc10_ != var_1912)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_739));
            if(_loc11_ != var_1036)
            {
               var_1036 = _loc11_;
               var_1914 = var_1036 & 255;
               var_1915 = var_1036 >> 8 & 255;
               var_1916 = var_1036 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1735 + const_1722 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1735 = _loc7_;
         if(var_166 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_546);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_627);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_522);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1910 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_974));
            var_166 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_417.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_417[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_202)
            {
               if(var_1910)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1914 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1915 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1916 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_104.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_205 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_202 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
