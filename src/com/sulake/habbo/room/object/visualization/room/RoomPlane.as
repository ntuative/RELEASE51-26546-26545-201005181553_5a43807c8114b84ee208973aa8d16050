package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1556:Boolean = true;
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(var_178 != null)
         {
            ...
            {
               _loc3_ = var_178.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      public function dispose() : void
      {
         ...
         if(var_178 != null)
         {
            ...
            {
               _loc2_ = var_178.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      {
         var _loc3_:PlaneBitmapData = var_178.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(var_910)
         {
            ...
            {
               _loc4_ = var_205[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_205 || _type == const_202))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_910 || false && false && !var_159 || var_566 == null)
         {
            return;
         }
         ...
         if(var_159)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_520);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_205.length)
            {
               _loc3_ = var_205[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = 0 - 0 * _loc3_.leftSideLoc / 0;
                  _loc11_ = 0 - 0 * _loc3_.rightSideLoc / 0;
                  _loc12_ = _loc3_.type;
                  var_566.updateMask(var_62,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_753.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_272.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1078.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_159 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_752 != null)
         {
            return var_752.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_205 || _type == const_202)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            ...
            {
               _loc4_ = var_205[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < var_753.length)
                  {
                     _loc7_ = var_753[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1157.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1157[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = var_178.getValue(_loc4_) as PlaneBitmapData;
         }
         updateMaskChangeStatus();
         if(_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_159)
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_752 != null)
            {
               _loc3_ = var_752.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1556,var_2108,var_2107,var_2105,var_2106,param2);
               if(_loc3_ != null)
               {
