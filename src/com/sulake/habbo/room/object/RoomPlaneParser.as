package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_887;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_801);
         addPlane(RoomPlaneData.const_144,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_144,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_113) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_144,Vector3d.sum(param1,Vector3d.product(param3,-var_113 / param3.length)),Vector3d.product(param3,(param3.length + var_113) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_801 / param2.length);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_761 = getFloorHeight(var_103);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_113),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_113),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_113),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_150,_loc13_,new Vector3d(0,0,-var_113),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
