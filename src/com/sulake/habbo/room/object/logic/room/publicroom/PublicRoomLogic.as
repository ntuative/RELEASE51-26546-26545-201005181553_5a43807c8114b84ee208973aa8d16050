package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_503,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_597,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_503,Number(false));
         var_799 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_835:
                  _loc2_.setString(RoomObjectVariableEnum.const_308,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_597,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_503,Number(true));
                  var_999 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_824);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_472)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_597);
