package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_420:IRoomSettingsCtrlOwner;
      ...
      private var var_1044:TextFieldManager;
      ...
      {
         close();
         this.var_420.roomSettingsRefreshNeeded();
      }
      ...
      private function populateForm() : void
      {
         ...
         var_1240.setText(_loc1_.description);
         var_1044.setText("");
         var_1237.setText("");
         ...
         changePasswordField(_loc1_.doorMode == RoomSettingsData.const_132);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         setCategorySelection(_loc1_.categoryId);
         refreshMaxVisitors(_loc1_);
         setTag(var_870,_loc1_.tags[0]);
         setTag(var_871,_loc1_.tags[1]);
         if(var_1241)
         {
            if(_loc1_.allowPets)
            {
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_420.roomSettingsRefreshNeeded();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_421);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_86.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_421]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_258.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_258.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_258.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_258.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_258.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_258.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_258.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_258);
         var_258.findChildByName("ruler").visible = true;
         ...
         if(var_86.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_258,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_73,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1499.visible = _inRoom;
         var_1923.visible = var_514;
         var_1922.visible = !var_514;
         if(var_514)
         {
         ...
         var_1498.text = !!var_514 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1501.name,var_1235.name,var_1042.name,var_1045.name,var_1236.name,var_1499.name],0,0);
      ...
      {
         this.var_421 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_421));
         if(var_1041 != null)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1240.getText();
         ...
         _loc2_.allowFoodConsume = var_1238.isSelected;
         _loc2_.allowWalkThrough = var_1239.isSelected;
         _loc2_.tags = new Array();
         addTag(var_870,_loc2_.tags);
         addTag(var_871,_loc2_.tags);
         this.clearErrors();
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_421));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_421 || var_1043 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_1043 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1216)
         {
         ...
         {
            setTagError(this.var_870,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_871,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1430)
         {
            setTagError(this.var_870,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_871,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1234)
         {
            this.var_1044.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_674,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_822,onDoorModePasswordUnselect);
         ...
         this.var_1240 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_870 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_871 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1044 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         ...
         this.var_1238 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1239 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1501 = IWindowContainer(_window.findChildByName("header_container"));
         var_1235 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1042 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1045 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1499 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1236 = IWindowContainer(_window.findChildByName("footer_container"));
         var_258 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1041 = IWindowContainer(_window.findChildByName("password_container"));
         var_1922 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1923 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1498 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1498.procedure = onSwitchView;
         var_1041.visible = false;
         if(!_inRoom)
         {
