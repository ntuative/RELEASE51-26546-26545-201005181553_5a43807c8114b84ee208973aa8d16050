package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2404:Dictionary;
      ...
      private var var_807:RoomCreateViewCtrl;
      ...
      private var var_578:RoomInfoViewCtrl;
      ...
      private var var_1044:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_578 = new RoomInfoViewCtrl(this);
         var_807 = new RoomCreateViewCtrl(this);
         var_1690 = new RoomThumbnailRenderer(this);
         var_1044 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_250.startSearch(Tabs.const_212,Tabs.const_329,param1);
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_250.startSearch(Tabs.const_264,Tabs.const_238);
         var_429.getTab(Tabs.const_264).tabPageDecorator.tabSelected();
      }
