package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1154:int = 267;
      
      private static const const_1152:int = 65;
      
      private static const const_1153:int = -70;
      ...
      private var var_806:UserCountRenderer;
      ...
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_806 = new UserCountRenderer(_navigator);
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_212,Tabs.const_329,_loc2_.tag);
         }
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         param3.x = !!param2.showDetails ? int(const_1153) : 0;
         param3.width = 274;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1427)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1152) : int(const_1154);
         refreshPicText(_loc3_,param2);
         method_6(_loc3_,param2);
      }
      ...
      private function method_6(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_537 || param2.type == OfficialRoomEntryData.const_642))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_806.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
