package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_345);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_721);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_250,Tabs.const_345,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_488 == null)
         {
            var_488 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_488.procedure = onChangeFilter;
