package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomSettingsSaved(param1:IMessageEvent) : void
      {
         ...
         _navigator.mainViewCtrl.reloadRoomList(Tabs.const_238);
      }
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.ROOMINFO));
            setToolbarExitIcon();
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         else if(_loc2_.roomForward)
         {
            ...
            else if(_loc2_.data.doorMode == RoomSettingsData.const_132 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
