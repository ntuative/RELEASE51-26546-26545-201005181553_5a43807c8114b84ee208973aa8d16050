package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1431:CutToHeight = new CutToHeight();
      
      private static var var_1430:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1430.beforeSearch(param2,param1,param3);
         binarySearch(var_1430,param2.length - 1);
      }
   }
}
