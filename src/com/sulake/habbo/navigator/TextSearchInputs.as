package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      private var var_2401:IButtonWindow;
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         _navigator = param1;
         var_2328 = param2;
         var_706 = new TextFieldManager(_navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,searchRooms,_navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = var_706.getText();
         if(_loc1_ == "")
         {
            return;
         }
         _navigator.mainViewCtrl.startSearch(Tabs.const_212,Tabs.const_246,_loc1_);
      }
   }
}
