package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1569,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1568,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1569 = IButtonWindow(find("top_tab"));
         var_1568 = IButtonWindow(find("obj_tab"));
         var_2149 = IWindowContainer(find("tile_grid"));
         var_2150 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1569,onTopTabButton);
         Util.setProcDirectly(var_1568,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2149;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_2150;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_73,new Rectangle(0,0,param1.width,66)));
