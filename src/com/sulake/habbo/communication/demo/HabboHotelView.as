package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_606:Function;
      
      private var _window:IWindowContainer;
      
      private var var_722:IAssetLibrary;
      
      private var var_873:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_722.loadAssetFromFile("hotel_view_banner_" + var_873,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_636));
            }
            var_607 = param2;
