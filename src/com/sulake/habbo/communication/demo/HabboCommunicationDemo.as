package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_177:HabboHotelView;
      ...
      private var var_1951:PseudoRandom;
      ...
      private var var_425:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1952)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1256,var_1950));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1464,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_425.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_425.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1951);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1464,"/");
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1256 = _habboConfiguration.getKey("flash.client.url","");
         var_1950 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_177 == null)
         {
            var_177 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_723 != null)
         {
            var_60.mode = HabboConnectionType.const_384;
            var_60.initConnection(HabboConnectionType.const_268);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1951 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_60.mode)
         {
            case HabboConnectionType.const_384:
               ...
               var_1046 = _loc4_;
               var_177.loadBannerImage(_loc7_ + "?token=" + var_1046,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_998:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1398:
               var_608 = generateRandomHexString(30);
               var_425 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_425.init(var_608);
               _loc8_ = var_425.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_177.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1046);
         ...
         var_425 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_425.init(_loc14_);
            _loc15_ = var_425.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_60.mode = HabboConnectionType.const_998;
            }
         }
         var_60.initConnection(HabboConnectionType.const_268);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_193,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_113,onRoomSessionEnded);
      }
