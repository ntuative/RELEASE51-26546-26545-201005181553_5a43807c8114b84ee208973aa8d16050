package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      private var var_1308:IHabboWebLogin;
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         _assets = param1;
         var_1308 = param2;
         var_1307 = "http://" + param3 + "/client";
         var_1308.init();
         var_1308.addEventListener(HabboWeb.const_209,requestClientURL);
      }
      ...
      {
         var _loc2_:String = var_1307;
         if(_assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + var_1307);
         }
         var _loc3_:URLRequest = new URLRequest(var_1307);
         if(_assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         {
            var_1308.requestReAuthenticate();
         }
         else
         {
            try
            {
               ...
               var_2099 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               if(false)
               {
