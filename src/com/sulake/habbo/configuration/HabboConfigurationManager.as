package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1488:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_554 = getKey("url_prefix");
         if(var_554 != null && false)
         {
            setKey("client.fatal.error.url",var_554 + "/flash_client_error");
         }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1421);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1118[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         var_554 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_554.replace("http://","");
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_799 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_193));
         if(var_2274)
         {
      ...
      {
         var _loc4_:String = var_1118[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_554);
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1488);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1488,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      private function init() : void
      {
         ...
         if(!var_799)
         {
            ...
            _loc4_.addEventListener(AssetLoaderEvent.const_51,onConfigurationError);
         }
      }
