package com.sulake.habbo.moderation
{
   ...
   public class PickedIssuesView implements IIssueBrowserView
   {
      ...
      private var var_1722:IssueListView;
      ...
      public function PickedIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         var_1722 = new IssueListView(param1,param2,_loc4_,"picked_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = _issueManager.getBundles(IssueManager.const_1030);
         var_1722.update(_loc1_);
      }
   }
}
