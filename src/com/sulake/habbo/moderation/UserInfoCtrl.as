package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_796:int = 31536000;
      
      private static const const_798:int = 86400;
      
      private static const const_797:int = 3600;
      
      private static const const_795:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_795) + " mins ago";
         }
         if(param1 < 2 * const_798)
         {
            return Math.round(param1 / const_797) + " hours ago";
         }
         if(param1 < 2 * const_796)
         {
            return Math.round(param1 / const_798) + " days ago";
         }
         return Math.round(param1 / const_796) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_1006,_data.userId),_callerFrame,var_1063,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1371),_callerFrame,var_1063,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_1063,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1371),_callerFrame,var_1063,false,true);
      }
