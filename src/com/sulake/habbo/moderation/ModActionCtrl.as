package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_776:OffenceCategoryData;
      
      private var var_456:ITextFieldWindow;
      
      private var var_948:IButtonWindow;
      ...
      private var var_777:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_946 = IButtonWindow(_main.getXmlWindow("modact_offence"));
         var_948 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_947.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1372,var_456.text,getBanLength(),var_1371));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_947.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1372,var_456.text,var_1371));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_776 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1372,var_456.text,var_1371));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_776 != null;
         if(this.var_777 != null)
         {
            var_53.findChildByName("offence_txt").caption = this.var_777.name;
            var_53.findChildByName("offence_category").visible = true;
         }
         else if(this.var_776 != null)
         {
            this.refreshButtons("offences_cont",2,var_776.offences,var_946,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_948,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_777 = var_776.offences[_loc3_];
         var_456.text = var_777.msg;
         var_308 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_53.caption = "Mod action on: " + var_1483;
         ...
         var_947 = IDropMenuWindow(var_53.findChildByName("banLengthSelect"));
         method_7(var_947);
