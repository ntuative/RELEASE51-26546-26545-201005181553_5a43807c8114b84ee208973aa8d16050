package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_935 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_936 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1421);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_935.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_936.clone());
         _loc4_.color = var_1358[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
