package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         var_427 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_1052 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_427.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_116.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1052.load(_loc4_,var_116.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_890,_loc2_),_window,false,false,true);
      }
