package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1537:IIssueBrowserView;
      
      private const const_1724:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1723:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1536:IIssueBrowserView;
      
      private const const_1741:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1725:String = "my_issues";
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_364.view.width = var_234.container.width;
         var_364.view.height = var_234.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1725:
               if(var_1536 == null)
               {
                  var_1536 = new MyIssuesView(issueManager,this,var_234.container);
               }
               return var_1536;
            case const_1724:
               if(var_1537 == null)
               {
                  var_1537 = new OpenIssuesView(issueManager,this,var_234.container);
               }
               return var_1537;
            case const_1723:
               if(var_1535 == null)
               {
                  var_1535 = new PickedIssuesView(issueManager,this,var_234.container);
               }
               return var_1535;
            default:
               return null;
