package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1926:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1926.clone());
      ...
      {
         var_1926 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1223;
      }
   }
}
