package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IAvatarImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_545 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_589 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_589.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_589.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_545.removeGridItem(_loc2_.window);
         if(var_301 == _loc2_)
         {
            var_301 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_589.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_545.addGridItem(_loc2_.window);
            var_589.add(param1.id,_loc2_);
            if(var_301 == null)
            {
               selectFirst();
            }
