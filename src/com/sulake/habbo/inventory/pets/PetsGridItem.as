package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_54:
               var_1075.setSelectedGridItem(this);
               var_905 = true;
               break;
            case WindowMouseEvent.const_102:
               var_905 = false;
               break;
            case WindowMouseEvent.const_33:
               ...
               {
                  var_905 = false;
                  var_1075.placePetToRoom(var_1163.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1708) : uint(const_1707);
      }
