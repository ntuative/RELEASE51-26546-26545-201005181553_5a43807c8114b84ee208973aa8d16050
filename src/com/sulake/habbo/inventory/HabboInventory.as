package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_851:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            var_19.events.removeEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
            var_19.events.removeEventListener(RoomSessionEvent.const_113,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_672));
      }
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_156));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_854));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1721);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_314));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_272:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_850.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_850.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_272));
      }
      ...
      {
         return var_46.getValue(InventoryCategory.const_346) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1029 = new IncomingMessages(this);
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
         var_19.events.addEventListener(RoomSessionEvent.const_113,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_346,_loc3_);
         ...
         var_46.add(InventoryCategory.const_672,_loc6_);
         ...
         var_46.add(InventoryCategory.const_156,_loc10_);
