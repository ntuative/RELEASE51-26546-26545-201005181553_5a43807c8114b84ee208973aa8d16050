package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         var_621 = new ThumbListManager(_assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",getActiveThumbListImageWidth(),getActiveThumbListImageHeight());
         var_620 = new ThumbListManager(_assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",getActiveThumbListImageWidth(),getActiveThumbListImageHeight());
      ...
      public function updateListViews() : void
      {
         ...
         var _loc2_:BitmapData = var_620.getListImage();
         ...
         var _loc4_:BitmapData = var_621.getListImage();
