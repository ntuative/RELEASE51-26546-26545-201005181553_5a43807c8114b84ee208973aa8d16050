package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_251:uint = 3;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_515 = false;
         var_724 = false;
         var_47.updateItemList(var_725);
         var_47.updateItemList(var_1263);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_47.alertPopup(TradingView.const_977);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_515 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_47.alertPopup(TradingView.const_1042);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_35 + " NEW STATE: " + param1 + " OWN: " + var_515 + " OTHER: " + var_724);
         ...
         {
            case const_161:
               if(param1 == const_180 || param1 == const_207)
               {
                  var_35 = param1;
                  _loc2_ = true;
               }
      ...
      public function close() : void
      {
         if(var_639)
         {
            if(var_35 != const_161 && var_35 != const_207)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_161;
            var_11.toggleInventorySubPage(InventorySubCategory.const_996);
            var_639 = false;
         }
         var_47.setMinimized(false);
      }
