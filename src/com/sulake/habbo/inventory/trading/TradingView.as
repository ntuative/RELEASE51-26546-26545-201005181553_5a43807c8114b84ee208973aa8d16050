package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_774:uint = 4284532064;
      
      private static const const_773:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_187)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_832)
            {
            ...
            var_346.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_386);
            var_346.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1445 == null)
         {
            var_1445 = createMinimizedWindow();
         }
         if(!var_1749)
         {
            return var_65;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_65)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_774) : uint(const_773);
            }
