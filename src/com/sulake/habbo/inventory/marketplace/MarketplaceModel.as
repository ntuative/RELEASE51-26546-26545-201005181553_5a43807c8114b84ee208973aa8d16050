package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(param1 != var_2218 || param2 != var_2219)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_2136);
      }
      ...
      {
         if(var_29 != null && false && var_239 != null)
         {
            var_29.furniModel.removeLockFrom(var_239.id);
            var_239 = null;
         }
      }
