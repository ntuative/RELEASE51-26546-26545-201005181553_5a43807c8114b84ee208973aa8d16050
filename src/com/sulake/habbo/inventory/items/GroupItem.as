package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1707:int = 13421772;
      ...
      protected var var_2321:BitmapData;
      
      protected var var_974:Boolean;
      ...
      protected var var_386:BitmapData;
      
      private const const_1475:Number = 0.2;
      
      protected var var_1419:Boolean;
      
      private const const_1474:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_693)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1582));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1413);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1475;
               _loc1_.blend = const_1475;
            }
            else
            {
               _window.blend = const_1474;
               _loc1_.blend = const_1474;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1419 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2321;
               _loc5_.visible = true;
            }
            else
            {
