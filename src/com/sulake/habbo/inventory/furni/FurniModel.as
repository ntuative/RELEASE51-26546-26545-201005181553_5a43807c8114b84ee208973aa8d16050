package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1063:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_465 = new Timer(const_1063,1);
         var_465.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_29.getSubCategoryViewId() == InventorySubCategory.const_272;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_693)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_465 != null)
            {
               var_465.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_465.stop();
               var_465 = null;
            }
            if(var_124 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_341)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_272:
               ...
               break;
            case InventorySubCategory.const_996:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_29.checkCategoryInitilization(InventoryCategory.const_346);
         ...
         if(param1 == InventoryCategory.const_78 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_303:
                  var_29.toggleInventoryPage(InventoryCategory.const_156);
            }
         }
      }
      ...
      {
         if(var_794 && param1.type == RoomEngineObjectEvent.const_220)
         {
            var_29.showView();
            var_794 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_307 || _loc3_.category == FurniCategory.const_341 || _loc3_.category == FurniCategory.const_300)
         {
            if(param1)
            {
               return false;
      ...
      public function clearFurniList() : void
      {
         ...
         var_394.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
