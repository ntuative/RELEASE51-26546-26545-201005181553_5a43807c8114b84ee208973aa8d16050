package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_523 = new Map();
         var_523.add(FurniModel.const_45,new FurniGridView(_model,FurniModel.const_45,_windowManager,_assetLibrary,_roomEngine));
         var_523.add(FurniModel.const_46,new FurniGridView(_model,FurniModel.const_46,_windowManager,_assetLibrary,_roomEngine));
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_523.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_523.getValue(var_522);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_522);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_341)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_782 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
      ...
      {
         var _loc3_:FurniGridView = var_523.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
