package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_545 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_545.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_545.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_545.addGridItemAt(param1,param2);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_54)
         {
            ...
            _model.toggleItemSelection(_category,var_545.getGridItemIndex(param1.window));
            var_376 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_33 && var_376 != null && var_376 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_256)
         {
