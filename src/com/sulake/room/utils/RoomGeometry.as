package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1049:Number = 32;
      ...
      private var var_2392:Number = 500;
      
      private var var_1579:Number = 1;
      
      private var var_84:Vector3d;
      
      private var var_85:Vector3d;
      
      private var var_2393:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1580 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_448 != param1 * var_1580)
         {
            var_448 = param1 * var_1580;
            ++var_79;
         }
      }
      ...
      {
         if(var_449 != param1 * var_1581)
         {
            var_449 = param1 * var_1581;
            ++var_79;
         }
      }
      ...
      {
         if(var_447 != param1 * var_1579)
         {
            var_447 = param1 * var_1579;
            ++var_79;
         }
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2393 || _loc3_ > var_2392)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_449,0 * var_447,0 * var_448);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_449,0 * var_447,0 * var_448);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_85;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_449,param2.y * var_447,param2.z * var_448);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_449,param3.y * var_447,param3.z * var_448);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_449,param4.y * var_447,param4.z * var_448);
