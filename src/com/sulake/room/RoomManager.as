package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_467:IRoomObjectFactory = null;
      
      private var var_1004:int;
      
      private var var_2399:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_469 = [];
         var_468 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_317,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_400,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_737,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_35 == const_1180)
         {
            if(var_798 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_467.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_467 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_467 != null)
         {
            return var_467.createRoomObjectManager();
         }
         return null;
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_467.createRoomObjectLogic(_loc18_);
